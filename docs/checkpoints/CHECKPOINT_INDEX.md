...
- `MEE_ADAPTIVE_ACQUISITION_YIELD_V1_20260803` — `2026-08-03` — Offline-proven adaptive market-listing scheduler: exhausted-page replacement, 90/10 discovery/precision budgets, low-yield shelf removal, 7,031 real-corpus candidates behind a 4,000-call ceiling, and a 714,081-row / 89.26% projected envelope before the required 200-call provider canary
