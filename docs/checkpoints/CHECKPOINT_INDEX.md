...
- `CARD_VISUAL_DESCRIPTION_AGENT_V1_ONE_CARD_APPLY_20260716` - `2026-07-16` - Completed one-card apply gate for the Canonical Card Visual Description Agent V1: private schema applied, RLS/grants verified, one OpenAI-backed description inserted for `GV-PK-JPN-M5-113`, row remained pending, and embeddings/app-facing integrations stayed closed
- `CARD_VISUAL_DESCRIPTION_PROMPT_V3_REPAIR_20260716` - `2026-07-16` - Completed first visual-description review repair: Mega Chandelure V1/V2 rows moved to `needs_review`, prompt V3 and deterministic quality flags added, and a same-card V3 row inserted as current `pending` without approval, embeddings, or app-facing exposure
- `CARD_VISUAL_DESCRIPTION_AGENT_V1_APPLY_GATE_BLOCKED_20260715` - `2026-07-15` - Blocked one-card apply gate for the Canonical Card Visual Description Agent V1: strict migration prepush found remote-only migration IDs before schema apply, so no migration, card apply, or DB write was performed
