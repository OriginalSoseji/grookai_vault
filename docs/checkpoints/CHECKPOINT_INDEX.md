...
- `MEE_OPERATIONAL_RECOVERY_V1` - `2026-08-02` - Non-destructive MEE recovery: preserves the deployed runtime, replaces mutable nightly execution with an immutable resumable pipeline, rotates acquisition coverage, and keeps all evidence internal while recovery gates are proven
