...
- `RELEASE_READINESS_AUDIT_20260731_V1.md` — `2026-07-31` — ACTIVE GATES — Records the production-proven wall-feed repair, merged pricing surfaces, TestFlight Build 258, current controlled-beta verdict, pending physical-iPhone proof, and the frozen post-72-hour pricing handoff.
