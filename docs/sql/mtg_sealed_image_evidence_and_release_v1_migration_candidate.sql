-- MTG_SEALED_IMAGE_EVIDENCE_AND_RELEASE_V1 migration candidate.
-- Review artifact only. This file is outside supabase/migrations and is not
-- visible to the production migration runner. It grants no mutation authority.
