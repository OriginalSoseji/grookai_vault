-- Bounded card-detail read function for MEE-PUBLIC-PRICING-BRIDGE-VARIANT-AWARE-V1.
--
-- The all-card view is useful as a contract surface but too expensive for
-- runtime card detail reads. This function filters by card_print_id before
-- touching variant evidence read models.

create or replace function public.get_market_evidence_public_pricing_bridge_variant_aware_v1(
...
revoke all on function public.get_market_evidence_public_pricing_bridge_variant_aware_v1(uuid) from public, anon, authenticated, service_role;
grant execute on function public.get_market_evidence_public_pricing_bridge_variant_aware_v1(uuid) to authenticated, service_role;
