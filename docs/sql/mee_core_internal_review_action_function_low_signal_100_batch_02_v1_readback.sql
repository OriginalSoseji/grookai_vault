-- MEE_CORE_INTERNAL_REVIEW_ACTION_FUNCTION_LOW_SIGNAL_100_BATCH_02_PLAN_V1 readback SQL.
...
with target_ids(id) as (
  ...
  where e.action_name = 'confirm_monitor_only'
    and e.action_payload ->> 'package_id' = 'MEE-CORE-INTERNAL-REVIEW-ACTION-FUNCTION-LOW-SIGNAL-100-BATCH-02-PLAN-V1'
    and e.action_payload ->> 'row_manifest_sha256' = 'e4193419f5e4e86aee1c673dc26c695495fc007ba1b8db94149b6ebac2717b11'
...
select
  ...
  (select count(*)::int from target_dispositions where needs_review = false and review_actor = 'system_low_signal_100_batch_02_plan' and review_status = 'resolved' and review_disposition = 'monitor_only') as updated_target_rows,
