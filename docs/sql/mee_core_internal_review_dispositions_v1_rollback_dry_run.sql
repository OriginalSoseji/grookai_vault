-- MEE_CORE_INTERNAL_REVIEW_DISPOSITIONS_SCHEMA_CANDIDATE_V1 rollback-only dry-run proof.
...
select
  'MEE_CORE_INTERNAL_REVIEW_DISPOSITIONS_SCHEMA_CANDIDATE_V1_ROLLBACK_DRY_RUN'::text as package_id,
  exists (
    select 1
