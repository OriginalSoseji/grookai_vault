...
-- Read-only closure audit for xy3 after:
...
--   canonical_count = 114
-- Closure status:
--   FAILED due to residual canonical normalization drift on GV-PK-FFI-55A.
...
where cp.gv_id in ('GV-PK-FFI-55', 'GV-PK-FFI-55A')
