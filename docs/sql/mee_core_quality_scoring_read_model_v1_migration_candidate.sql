-- MEE-CORE-QUALITY-SCORING-READ-MODEL-SCHEMA-CANDIDATE-V1 local migration candidate.
...
select
  'MEE-CORE-QUALITY-SCORING-READ-MODEL-SCHEMA-CANDIDATE-V1'::text as package_id,
