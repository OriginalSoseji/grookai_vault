-- MARKET_REFERENCE_WAREHOUSE_V1 migration candidate.
-- Purpose: proposed schema only for free-reference Market Evidence Engine storage.
...
select
  'MARKET_REFERENCE_WAREHOUSE_V1_MIGRATION_CANDIDATE'::text as package_id,
