-- MTG_SEALED_IMAGE_BACKED_PRICING_RPC_V3_CANDIDATE
-- Review artifact only. This file is intentionally outside supabase/migrations.
-- It depends on the unapplied MTG sealed image schema candidate and authorizes
-- no migration application, data write, pointer change, or visibility change.
