-- MARKET_REFERENCE_SIGNAL_ROLLUPS_V1 migration candidate.
-- Purpose: proposed schema only for internal reference signal rollup storage.
-- Boundary: no pricing_observations writes, no price rollups into public/app surfaces.
-- This is a review artifact, not an applied Supabase migration.
...
select
  'MARKET_REFERENCE_SIGNAL_ROLLUPS_V1_MIGRATION_CANDIDATE'::text as package_id,
