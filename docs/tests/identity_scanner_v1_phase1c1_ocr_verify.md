# Identity Scanner V1 Phase 1C.1 — OCR Signals Verification Notes
...
4) Inspect `identity_scan_event_results` for the event:
   ...
   - `signals` should include: `name_ocr`, `name_conf`, `number_raw`, `number_conf`, `number_digits`, `printed_total`, `total_conf`, `printed_set_abbrev_raw`, `set_abbrev_conf`, plus border/warp metadata.
