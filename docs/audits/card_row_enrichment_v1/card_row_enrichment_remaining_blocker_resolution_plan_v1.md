...
| --- | --- | --- | --- | --- |
| core_identity | 0 | blocked_governance_required | false | Split into Pocket cleanup/exclusion decision, collision ownership adjudication, and subset alias governance packages. |
