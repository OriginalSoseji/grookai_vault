...
Prize Pack product-family rows are accepted only for stamped remaining gaps. Expansion rows require exact name, card number, and set denominator; promo rows require exact promo number and name.
