# pkmngg_stamped_finish Source Delta Audit V1
...
| Reason | Count |
| --- | --- |
| already_in_current_index_master_verified | 49 |
| not_in_remaining_gaps_or_current_index | 1 |

## Useful Matches

| Status | Gap | Set | Number | Card | Finish | Candidate Source | Authority |
| --- | --- | --- | --- | --- | --- | --- | --- |
| suppressed_claim_review_evidence | suppressed_structured_claim_reviewed | sv10 | 087 | Team Rocket's Mimikyu | holo | pkmngg_stamped_finish | pkmn.gg |
