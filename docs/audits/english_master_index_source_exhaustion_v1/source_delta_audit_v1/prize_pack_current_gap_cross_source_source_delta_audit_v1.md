# prize_pack_current_gap_cross_source Source Delta Audit V1
...
| candidate_records_loaded | 24 |
| matched_gap_facts | 16 |
| useful_candidate_matches | 0 |
| already_in_current_index | 8 |
...
| Status | Count |
| --- | --- |
| same_source_or_authority | 16 |

## Non-Gap Candidate Counts

| Reason | Count |
| --- | --- |
| already_in_current_index_master_verified | 8 |
