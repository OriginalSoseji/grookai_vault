# TCGMAP-07B-FRESH-TCGCSV-TCGPLAYER-MAPPING-INSERTS Real Apply

Scoped real apply for fresh TCGCSV-derived TCGplayer external mappings.

## Result

- pass: true
- approved_by_user: `Approve real TCGMAP-07B-FRESH-TCGCSV-TCGPLAYER-MAPPING-INSERTS apply only.`
...
- inserted rows: 371
- target active rows after apply: 371
