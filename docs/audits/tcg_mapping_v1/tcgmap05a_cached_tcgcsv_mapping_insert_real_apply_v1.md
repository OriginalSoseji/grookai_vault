# TCGMAP-05A-CACHED-TCGCSV-TCGPLAYER-MAPPING-INSERTS Real Apply

Scoped real apply for cached TCGCSV-derived TCGplayer external mappings.

## Result

- pass: true
- approved_by_user: `Approve real TCGMAP-05A-CACHED-TCGCSV-TCGPLAYER-MAPPING-INSERTS apply only.`
...
- inserted rows: 153
- target active rows after apply: 153
...
- parent_writes: false
- child_writes: false
- source: `external_mappings` inserts only
