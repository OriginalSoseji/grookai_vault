# TCGMAP-08B-FRESH-TCGCSV-TCGPLAYER-MAPPING-INSERTS Real Apply
...
- pass: true
- approved_by_user: `Approve real TCGMAP-08B-FRESH-TCGCSV-TCGPLAYER-MAPPING-INSERTS apply only.`
...
- inserted rows: 71
- target active rows after apply: 71
