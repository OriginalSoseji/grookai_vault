# TCGMAP-04A-STAGING-TCGPLAYER-MAPPING-INSERTS Real Apply

Scoped real apply for staging-resolved TCGplayer external mappings.

## Result

- pass: true
- approved_by_user: `Approve real TCGMAP-04A-STAGING-TCGPLAYER-MAPPING-INSERTS apply only.`
...
- inserted rows: 728
- target active rows after apply: 728
