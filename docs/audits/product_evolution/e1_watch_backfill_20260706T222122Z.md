...
Generated: 2026-07-06T22:21:22.830Z
Mode: apply
User scope: all
Limit users: 25
After user id: none
...
| --- | --- | --- | ---: | ---: | ---: | ---: |
| collector_follows | collector | manual | 5 | 2 | 5 | 0 |
| owned_cards | card | owned | 354 | 19 | 354 | 0 |
| owned_sets_3plus | set | inferred | 25 | 3 | 25 | 0 |
| wishlist_items | card | want | 1 | 1 | 1 | 0 |
...
| --- | --- | --- | ---: | ---: |
| card | owned | backfill_v1 | 354 | 19 |
| card | want | backfill_v1 | 1 | 1 |
| collector | manual | backfill_v1 | 5 | 2 |
| set | inferred | backfill_v1 | 25 | 3 |
