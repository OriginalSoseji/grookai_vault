...
- Package fingerprint: `53b8afc941456e0059959a9b4e113c734b76a21264b30ac42c0678fe3a1e539e`
...
[
  ...
  },
  {
    ...
    "command": "node scripts/audits/market_listing_acquisition_daily_batch_fetch_v1.mjs --batch-plan=<latest daily batch plan>",
    "provider_calls": true,
    "db_writes": false
  },
  {
    "key": "daily_batch_backfill_plan",
    "command": "node scripts/audits/market_listing_acquisition_daily_batch_backfill_plan_v1.mjs --fetch=<latest fetch artifact>",
    "provider_calls": false,
    "db_writes": false
  },
  {
    "key": "daily_batch_backfill_apply",
    "command": "node scripts/audits/market_listing_acquisition_daily_batch_backfill_apply_v1.mjs --plan=<latest backfill plan> --apply",
    "provider_calls": false,
    "db_writes": true
  },
  {
  ...
  },
  {
    ...
    "command": "node scripts/audits/market_listing_strict_filtered_rollup_apply_v1.mjs --approved-report=<same-run strict apply readiness> --apply",
    "provider_calls": false,
    "db_writes": true
  },
  {
...
```json
{
  ...
  "fixed_rollup_presence": {
    ...
    "existing_fixed_strict_rollup_count": 2
  },
  "missing_scripts": []
}
```
...
- fixed_strict_rollup_versions_already_exist_run_specific_versions_required
- artifact_plumbing_placeholders_present
