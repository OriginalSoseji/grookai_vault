...
- Package fingerprint: `cc43f0fb1a1672a4088c497a24431b9884c347bd1955e8803f1148998e2ed329`
...
[
  ...
  },
  {
    ...
    "command": "node scripts/audits/market_listing_acquisition_daily_batch_backfill_apply_v1.mjs --apply",
    "provider_calls": false,
    "db_writes": true
  },
  {
...
```json
{
  ...
  "dynamic_backfill_apply_support": false,
  "missing_scripts": []
}
```
...
- daily_batch_backfill_apply_dynamic_idempotency_required
