...
- Fingerprint: `969085b81bd0397cc82c08c336720ef285aef04a4b32f9cbae16d37c351ff42f`
...
```json
{
  "candidate_rows_total": 108600,
  "candidate_rows_strict_title_passed": 99159,
  "candidate_rows_strict_title_excluded": 9441,
  "strict_filtered_rollup_count": 2243,
  "strict_filtered_review_ready_count": 1920,
  "strict_filtered_needs_more_evidence_count": 323,
  "raw_single_passed_candidates": 72195,
  "slab_passed_candidates": 26964
}
```
...
```json
{
  ...
  "foreign_language_title_noise": 4522,
  "base_lane_missing_exact_number": 3,
  "lot_or_bulk_title_noise": 1413,
  "missing_pokemon_token": 2
}
```
