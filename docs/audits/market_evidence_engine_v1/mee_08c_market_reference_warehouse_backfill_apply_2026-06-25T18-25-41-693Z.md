...
- apply_failed:[market-reference-backfill-apply] insert failed for market_reference_acquisition_runs: Could not find the table 'public.market_reference_acquisition_runs' in the schema cache
