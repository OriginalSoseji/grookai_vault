...
- Run attempted: `false`
- Run key: `MEE-DROPLET-LOCAL-DRY-RUN-2026-06-27`
- Contract hash: `2b87af4aa106d5ee621c2c212a9c6508e70ef9a41186b6a8b82b9b58644813d0`
- Package fingerprint: `3a1ffedce22fb8b9b950d75907a552bf70a9fd59f272626b5a5a4ad79b452627`
...
[
  ...
  },
  {
    ...
    "command": "node scripts/audits/market_listing_strict_filtered_rollup_apply_v1.mjs --allow-dynamic-plan --run-key=MEE-DROPLET-LOCAL-DRY-RUN-2026-06-27 --apply",
    "provider_calls": false,
    "db_writes": true
  },
  {
    "key": "nightly_readback",
    "command": "node scripts/audits/market_listing_nightly_ingest_readback_v1.mjs --run-key=MEE-DROPLET-LOCAL-DRY-RUN-2026-06-27",
    "provider_calls": false,
    "db_writes": false
  }
]
...
```json
{
  ...
  "planned_strict_rollup_versions": [
    "MEE_12B_INTERNAL_RAW_SINGLE_STRICT_FILTERED_ACTIVE_ASK_REVIEW_V1__MEE_DROPLET_LOCAL_DRY_RUN_2026_06_27",
    "MEE_12B_INTERNAL_SLAB_STRICT_FILTERED_ACTIVE_ASK_REVIEW_V1__MEE_DROPLET_LOCAL_DRY_RUN_2026_06_27"
  ],
