...
- Package fingerprint: `c7ff0174cbb24b20a12f97f54bce88e92e597fec921dca57cab8de57421fe1e6`
...
- `scripts/audits/market_listing_strict_filtered_rollup_apply_v1.mjs`: needed to insert strict-filtered review-only candidates/rollups instead of the older unfiltered rollups
...
- `scripts/audits/market_listing_nightly_ingest_readback_v1.mjs`: needed for the final morning report required by the contract
