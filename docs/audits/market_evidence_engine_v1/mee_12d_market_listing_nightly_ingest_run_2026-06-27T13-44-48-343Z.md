...
- Run attempted: `false`
- Run key: `MEE-DROPLET-PIPELINE-CHECK-2026-06-28`
- Contract hash: `2b87af4aa106d5ee621c2c212a9c6508e70ef9a41186b6a8b82b9b58644813d0`
- Package fingerprint: `f8b08d5c6d3a569e0e80fef42ce93adf7fecdb61a604038213330a0b58f1e137`
...
[
  ...
  },
  {
    ...
    "command": "node scripts/audits/market_listing_strict_filtered_rollup_apply_v1.mjs --allow-dynamic-plan --run-key=MEE-DROPLET-PIPELINE-CHECK-2026-06-28 --apply",
    "provider_calls": false,
    "db_writes": true
  },
  {
    "key": "nightly_readback",
    "command": "node scripts/audits/market_listing_nightly_ingest_readback_v1.mjs --run-key=MEE-DROPLET-PIPELINE-CHECK-2026-06-28",
    "provider_calls": false,
    "db_writes": false
  }
]
...
```json
{
  ...
  "planned_strict_rollup_versions": [
    "MEE_12B_INTERNAL_RAW_SINGLE_STRICT_FILTERED_ACTIVE_ASK_REVIEW_V1__MEE_DROPLET_PIPELINE_CHECK_2026_06_28",
    "MEE_12B_INTERNAL_SLAB_STRICT_FILTERED_ACTIVE_ASK_REVIEW_V1__MEE_DROPLET_PIPELINE_CHECK_2026_06_28"
  ],
