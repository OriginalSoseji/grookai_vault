...
| Phase 6 | Fresh snapshot and guarded execution artifact | pkg01_reconcile_dry_run_preview_complete_apply_blocked_no_write | Only after explicit approval: refresh the snapshot, verify this dry-run preview still matches, then create an executable dry-run-default transaction artifact. |
