...
| category | count |
| --- | --- |
| holo_overgeneration_candidate | 3847 |
| invalid_or_unknown_card_number_review | 1 |
| modern_parallel_exact_finish_needs_source | 167 |
| modern_parallel_set_review | 524 |
| normal_variant_not_in_index_review | 13 |
| product_or_deck_set_source_coverage_gap | 1027 |
| promo_family_source_coverage_gap | 2680 |
| reverse_holo_overgeneration_candidate | 1252 |
...
| sm11 | 84 | Mesprit | holo | normal, reverse | The index knows this exact card identity but does not support Grookai's holo finish in this audit pass. |
...
| sm11 | 101 | Necrozma | holo | normal, reverse | The index knows this exact card identity but does not support Grookai's holo finish in this audit pass. |
...
| sv05 | 078 | Flutter Mane | normal | holo, reverse | The index knows this exact card identity but does not support Grookai's normal finish in this audit pass. |
...
| swsh11 | 17 | Trevenant | normal | holo, reverse | The index knows this exact card identity but does not support Grookai's normal finish in this audit pass. |
| swsh11 | 26 | Chandelure | normal | holo, reverse | The index knows this exact card identity but does not support Grookai's normal finish in this audit pass. |
...
| bw1 | 107 | Water Energy | reverse | normal | The index knows this exact card identity but does not support Grookai's reverse finish in this audit pass. |
...
| bw1 | 105 | Grass Energy | reverse | normal | The index knows this exact card identity but does not support Grookai's reverse finish in this audit pass. |
...
| bw1 | 106 | Fire Energy | reverse | normal | The index knows this exact card identity but does not support Grookai's reverse finish in this audit pass. |
...
| bw1 | 111 | Darkness Energy | reverse | normal | The index knows this exact card identity but does not support Grookai's reverse finish in this audit pass. |
...
| sm115 | 20 | Raichu-GX | reverse | holo, normal | The index knows this exact card identity but does not support Grookai's reverse finish in this audit pass. |
| sm115 | 31 | Mewtwo-GX | reverse | holo, normal | The index knows this exact card identity but does not support Grookai's reverse finish in this audit pass. |
...
| ecard3 | H4 | Beedrill | normal |  | No exact card identity fact was found in the current index for this Grookai row. |
| ecard3 | H6 | Dewgong | normal |  | No exact card identity fact was found in the current index for this Grookai row. |
| me01 | 104 | Mega Kangaskhan ex | normal |  | No exact card identity fact was found in the current index for this Grookai row. |
| ecard2 | 103 | Porygon | reverse |  | No exact card identity fact was found in the current index for this Grookai row. |
| ecard2 | 103 | Porygon | reverse |  | No exact card identity fact was found in the current index for this Grookai row. |
| hsp | 04 | Wobbuffet | holo |  | No exact card identity fact was found in the current index for this Grookai row. |
| ecard2 | 103 | Porygon | normal |  | No exact card identity fact was found in the current index for this Grookai row. |
| ecard2 | 103 | Porygon | normal |  | No exact card identity fact was found in the current index for this Grookai row. |
...
| cel25 | 97 | Xerneas-EX | normal |  | Subset, gallery, or number-collision family needs set/subset identity resolution before judging printing support. |
| cel25 | 4 | Charizard | normal |  | Subset, gallery, or number-collision family needs set/subset identity resolution before judging printing support. |
| cel25 | 88 | Mew ex | normal |  | Subset, gallery, or number-collision family needs set/subset identity resolution before judging printing support. |
| cel25 | 15 | Venusaur | normal |  | Subset, gallery, or number-collision family needs set/subset identity resolution before judging printing support. |
| cel25 | 2 | Blastoise | normal |  | Subset, gallery, or number-collision family needs set/subset identity resolution before judging printing support. |
| cel25 | 20 | Cleffa | normal |  | Subset, gallery, or number-collision family needs set/subset identity resolution before judging printing support. |
| cel25 | 54 | Mewtwo-EX | normal |  | Subset, gallery, or number-collision family needs set/subset identity resolution before judging printing support. |
| cel25 | 60 | Tapu Lele-GX | normal |  | Subset, gallery, or number-collision family needs set/subset identity resolution before judging printing support. |
| cel25 | 76 | M Rayquaza-EX | normal |  | Subset, gallery, or number-collision family needs set/subset identity resolution before judging printing support. |
| cel25 | 114 | Zekrom | normal |  | Subset, gallery, or number-collision family needs set/subset identity resolution before judging printing support. |
| cel25 | 17 | Umbreon ★ | normal |  | Subset, gallery, or number-collision family needs set/subset identity resolution before judging printing support. |
| cel25 | 93 | Gardevoir ex δ | normal |  | Subset, gallery, or number-collision family needs set/subset identity resolution before judging printing support. |
| cel25 | 109 | Luxray GL LV.X | normal |  | Subset, gallery, or number-collision family needs set/subset identity resolution before judging printing support. |
