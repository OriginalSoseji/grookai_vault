...
| base3 | 1 | Aerodactyl | stamped | human_source_verified | thepricedex_price_list | The index has human-readable/checklist evidence, but not full master verification, and Grookai does not exactly match it. |
| base3 | 15 | Zapdos | cosmos | human_source_verified | thepricedex_price_list | The index has human-readable/checklist evidence, but not full master verification, and Grookai does not exactly match it. |
| base3 | 50 | Kabuto | stamped | human_source_verified | thepricedex_price_list | The index has human-readable/checklist evidence, but not full master verification, and Grookai does not exactly match it. |
| base4 | 63 | Wartortle | stamped | human_source_verified | thepricedex_price_list | The index has human-readable/checklist evidence, but not full master verification, and Grookai does not exactly match it. |
...
| pl2 | 54 | Whiscash 4 | reverse | candidate_unconfirmed | tcgdex | Subset, gallery, or number-collision missing row needs set/subset identity resolution before any repair path. |
| pl2 | 60 | Flareon 4 | normal | candidate_unconfirmed | tcgdex | Subset, gallery, or number-collision missing row needs set/subset identity resolution before any repair path. |
