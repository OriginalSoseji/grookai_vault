...
Index printing facts: 38810

## Status Summary

| status | count |
| --- | --- |
| api_agreed_by_index | 21115 |
| candidate_unconfirmed_by_index | 11497 |
...
| status | finish | count |
| --- | --- | --- |
| api_agreed_by_index | holo | 3505 |
| api_agreed_by_index | normal | 11237 |
| api_agreed_by_index | reverse | 6373 |
| candidate_unconfirmed_by_index | holo | 3175 |
| candidate_unconfirmed_by_index | normal | 3280 |
| candidate_unconfirmed_by_index | reverse | 5042 |
| master_verified_by_index | cosmos | 7 |
| master_verified_by_index | holo | 142 |
| master_verified_by_index | normal | 153 |
| master_verified_by_index | pokeball | 130 |
| master_verified_by_index | reverse | 178 |
| master_verified_by_index | rocket_reverse | 10 |
| missing_from_grookai | first_edition_holo | 151 |
| missing_from_grookai | first_edition_normal | 940 |
| missing_from_grookai | holo | 2038 |
| missing_from_grookai | normal | 1598 |
| missing_from_grookai | reverse | 1300 |
| name_mismatch_needs_review | holo | 58 |
| name_mismatch_needs_review | normal | 41 |
| name_mismatch_needs_review | reverse | 31 |
| set_unmapped | holo | 3923 |
| set_unmapped | normal | 3753 |
| set_unmapped | reverse | 3848 |
| unsupported_by_current_index | holo | 5860 |
| unsupported_by_current_index | masterball | 67 |
| unsupported_by_current_index | normal | 1313 |
| unsupported_by_current_index | pokeball | 100 |
| unsupported_by_current_index | reverse | 3040 |

## Issue Sample

| set | number | name | finish | status | note |
| --- | --- | --- | --- | --- | --- |
| me03 | 027 | Luxio | reverse | candidate_unconfirmed_by_index | Exact set, number, name, and finish matched the current index. |
| me03 | 028 | Luxray | reverse | candidate_unconfirmed_by_index | Exact set, number, name, and finish matched the current index. |
| me03 | 029 | Dedenne | reverse | candidate_unconfirmed_by_index | Exact set, number, name, and finish matched the current index. |
| me03 | 036 | Aromatisse | reverse | candidate_unconfirmed_by_index | Exact set, number, name, and finish matched the current index. |
| me03 | 074 | Hole-Digging Shovel | reverse | candidate_unconfirmed_by_index | Exact set, number, name, and finish matched the current index. |
| me03 | 001 | Spinarak | reverse | candidate_unconfirmed_by_index | Exact set, number, name, and finish matched the current index. |
| me03 | 002 | Ariados | reverse | candidate_unconfirmed_by_index | Exact set, number, name, and finish matched the current index. |
| me03 | 003 | Shaymin | reverse | candidate_unconfirmed_by_index | Exact set, number, name, and finish matched the current index. |
| me03 | 004 | Snivy | reverse | candidate_unconfirmed_by_index | Exact set, number, name, and finish matched the current index. |
| me03 | 005 | Servine | reverse | candidate_unconfirmed_by_index | Exact set, number, name, and finish matched the current index. |
| me03 | 006 | Serperior | reverse | candidate_unconfirmed_by_index | Exact set, number, name, and finish matched the current index. |
| me03 | 007 | Scatterbug | reverse | candidate_unconfirmed_by_index | Exact set, number, name, and finish matched the current index. |
| me03 | 008 | Spewpa | reverse | candidate_unconfirmed_by_index | Exact set, number, name, and finish matched the current index. |
| me03 | 009 | Vivillon | reverse | candidate_unconfirmed_by_index | Exact set, number, name, and finish matched the current index. |
| me03 | 010 | Rowlet | reverse | candidate_unconfirmed_by_index | Exact set, number, name, and finish matched the current index. |
| me03 | 011 | Dartrix | reverse | candidate_unconfirmed_by_index | Exact set, number, name, and finish matched the current index. |
| me03 | 013 | Fletchinder | reverse | candidate_unconfirmed_by_index | Exact set, number, name, and finish matched the current index. |
| me03 | 014 | Talonflame | reverse | candidate_unconfirmed_by_index | Exact set, number, name, and finish matched the current index. |
...
| me03 | 015 | Salandit | reverse | candidate_unconfirmed_by_index | Exact set, number, name, and finish matched the current index. |
| sm11 | 258 | Weakness Guard Energy | holo | candidate_unconfirmed_by_index | Exact set, number, name, and finish matched the current index. |
| me03 | 017 | Turtonator | reverse | candidate_unconfirmed_by_index | Exact set, number, name, and finish matched the current index. |
| me03 | 018 | Seel | reverse | candidate_unconfirmed_by_index | Exact set, number, name, and finish matched the current index. |
| me03 | 019 | Dewgong | reverse | candidate_unconfirmed_by_index | Exact set, number, name, and finish matched the current index. |
| me03 | 020 | Staryu | reverse | candidate_unconfirmed_by_index | Exact set, number, name, and finish matched the current index. |
| me03 | 023 | Amaura | reverse | candidate_unconfirmed_by_index | Exact set, number, name, and finish matched the current index. |
| me03 | 024 | Aurorus | reverse | candidate_unconfirmed_by_index | Exact set, number, name, and finish matched the current index. |
| me03 | 025 | Volcanion | reverse | candidate_unconfirmed_by_index | Exact set, number, name, and finish matched the current index. |
| me03 | 026 | Shinx | reverse | candidate_unconfirmed_by_index | Exact set, number, name, and finish matched the current index. |
| me03 | 030 | Clefairy | reverse | candidate_unconfirmed_by_index | Exact set, number, name, and finish matched the current index. |
| me03 | 032 | Mawile | reverse | candidate_unconfirmed_by_index | Exact set, number, name, and finish matched the current index. |
| me03 | 033 | Espurr | reverse | candidate_unconfirmed_by_index | Exact set, number, name, and finish matched the current index. |
| me03 | 034 | Meowstic | reverse | candidate_unconfirmed_by_index | Exact set, number, name, and finish matched the current index. |
| me03 | 035 | Spritzee | reverse | candidate_unconfirmed_by_index | Exact set, number, name, and finish matched the current index. |
| me03 | 037 | Nosepass | reverse | candidate_unconfirmed_by_index | Exact set, number, name, and finish matched the current index. |
| me03 | 038 | Probopass | reverse | candidate_unconfirmed_by_index | Exact set, number, name, and finish matched the current index. |
| me03 | 039 | Hippopotas | reverse | candidate_unconfirmed_by_index | Exact set, number, name, and finish matched the current index. |
| me03 | 040 | Hippowdon | reverse | candidate_unconfirmed_by_index | Exact set, number, name, and finish matched the current index. |
| me03 | 041 | Landorus | reverse | candidate_unconfirmed_by_index | Exact set, number, name, and finish matched the current index. |
| me03 | 042 | Binacle | reverse | candidate_unconfirmed_by_index | Exact set, number, name, and finish matched the current index. |
| me03 | 043 | Barbaracle | reverse | candidate_unconfirmed_by_index | Exact set, number, name, and finish matched the current index. |
| me03 | 044 | Tyrunt | reverse | candidate_unconfirmed_by_index | Exact set, number, name, and finish matched the current index. |
| me03 | 045 | Tyrantrum | reverse | candidate_unconfirmed_by_index | Exact set, number, name, and finish matched the current index. |
| me03 | 046 | Hawlucha | reverse | candidate_unconfirmed_by_index | Exact set, number, name, and finish matched the current index. |
| me03 | 048 | Gastly | reverse | candidate_unconfirmed_by_index | Exact set, number, name, and finish matched the current index. |
| me03 | 049 | Haunter | reverse | candidate_unconfirmed_by_index | Exact set, number, name, and finish matched the current index. |
| me03 | 050 | Gengar | reverse | candidate_unconfirmed_by_index | Exact set, number, name, and finish matched the current index. |
| me03 | 051 | Skorupi | reverse | candidate_unconfirmed_by_index | Exact set, number, name, and finish matched the current index. |
| me03 | 052 | Drapion | reverse | candidate_unconfirmed_by_index | Exact set, number, name, and finish matched the current index. |
| me03 | 054 | Chien-Pao | reverse | candidate_unconfirmed_by_index | Exact set, number, name, and finish matched the current index. |
| me03 | 056 | Honedge | reverse | candidate_unconfirmed_by_index | Exact set, number, name, and finish matched the current index. |
| me03 | 057 | Doublade | reverse | candidate_unconfirmed_by_index | Exact set, number, name, and finish matched the current index. |
| me03 | 058 | Aegislash | reverse | candidate_unconfirmed_by_index | Exact set, number, name, and finish matched the current index. |
| me03 | 059 | Klefki | reverse | candidate_unconfirmed_by_index | Exact set, number, name, and finish matched the current index. |
| me03 | 060 | Rattata | reverse | candidate_unconfirmed_by_index | Exact set, number, name, and finish matched the current index. |
| me03 | 061 | Raticate | reverse | candidate_unconfirmed_by_index | Exact set, number, name, and finish matched the current index. |
| me03 | 063 | Snorlax | reverse | candidate_unconfirmed_by_index | Exact set, number, name, and finish matched the current index. |
| me03 | 064 | Bunnelby | reverse | candidate_unconfirmed_by_index | Exact set, number, name, and finish matched the current index. |
| me03 | 065 | Diggersby | reverse | candidate_unconfirmed_by_index | Exact set, number, name, and finish matched the current index. |
| me03 | 066 | Fletchling | reverse | candidate_unconfirmed_by_index | Exact set, number, name, and finish matched the current index. |
| me03 | 067 | Furfrou | reverse | candidate_unconfirmed_by_index | Exact set, number, name, and finish matched the current index. |
| me03 | 068 | Antique Jaw Fossil | reverse | candidate_unconfirmed_by_index | Exact set, number, name, and finish matched the current index. |
| me03 | 069 | Antique Sail Fossil | reverse | candidate_unconfirmed_by_index | Exact set, number, name, and finish matched the current index. |
| me03 | 070 | Core Memory | reverse | candidate_unconfirmed_by_index | Exact set, number, name, and finish matched the current index. |
| me03 | 071 | Crushing Hammer | reverse | candidate_unconfirmed_by_index | Exact set, number, name, and finish matched the current index. |
| me03 | 072 | Energy Search | reverse | candidate_unconfirmed_by_index | Exact set, number, name, and finish matched the current index. |
| me03 | 073 | Energy Swatter | reverse | candidate_unconfirmed_by_index | Exact set, number, name, and finish matched the current index. |
| me03 | 075 | Jacinthe | reverse | candidate_unconfirmed_by_index | Exact set, number, name, and finish matched the current index. |
| me03 | 076 | Judge | reverse | candidate_unconfirmed_by_index | Exact set, number, name, and finish matched the current index. |
...
| sm11 | 255 | U-Turn Board | holo | candidate_unconfirmed_by_index | Exact set, number, name, and finish matched the current index. |
...
| me03 | 077 | Lumiose City | reverse | candidate_unconfirmed_by_index | Exact set, number, name, and finish matched the current index. |
| me03 | 078 | Lumiose Galette | reverse | candidate_unconfirmed_by_index | Exact set, number, name, and finish matched the current index. |
| me03 | 079 | Naveen | reverse | candidate_unconfirmed_by_index | Exact set, number, name, and finish matched the current index. |
...
| me03 | 083 | Potion | reverse | candidate_unconfirmed_by_index | Exact set, number, name, and finish matched the current index. |
| me03 | 084 | Rosa's Encouragement | reverse | candidate_unconfirmed_by_index | Exact set, number, name, and finish matched the current index. |
| me03 | 085 | Tarragon | reverse | candidate_unconfirmed_by_index | Exact set, number, name, and finish matched the current index. |
| me03 | 086 | Growing Grass Energy | reverse | candidate_unconfirmed_by_index | Exact set, number, name, and finish matched the current index. |
| me03 | 087 | Rocky Fighting Energy | reverse | candidate_unconfirmed_by_index | Exact set, number, name, and finish matched the current index. |
| me03 | 088 | Telepathic Psychic Energy | reverse | candidate_unconfirmed_by_index | Exact set, number, name, and finish matched the current index. |
...
| me02 | 014 | Moltres | normal | candidate_unconfirmed_by_index | Exact set, number, name, and finish matched the current index. |
...
| col1 | 14 | Lucario | normal | candidate_unconfirmed_by_index | Exact set, number, name, and finish matched the current index. |
...
| g1 | 26 | Floral Crown | normal | set_unmapped | Grookai set_code was not present in the current English Master Index source set map. |
...
| sm11 | 7 | Sewaddle | reverse | candidate_unconfirmed_by_index | Exact set, number, name, and finish matched the current index. |
...
| sm11 | 70 | Xurkitree | reverse | candidate_unconfirmed_by_index | Exact set, number, name, and finish matched the current index. |
...
| sm11 | 71 | Mewtwo & Mew-GX | holo | candidate_unconfirmed_by_index | Exact set, number, name, and finish matched the current index. |
...
| svp | 112 | Bisharp | normal | candidate_unconfirmed_by_index | Exact set, number, name, and finish matched the current index. |
...
| ecard3 | 130 | Miracle Sphere β | normal | candidate_unconfirmed_by_index | Exact set, number, name, and finish matched the current index. |
...
| bw11 | 23 | Victini | normal | candidate_unconfirmed_by_index | Exact set, number, name, and finish matched the current index. |
| bw11 | 50 | Thundurus | normal | candidate_unconfirmed_by_index | Exact set, number, name, and finish matched the current index. |
...
| basep | 1 | Pikachu | normal | candidate_unconfirmed_by_index | Exact set, number, name, and finish matched the current index. |
...
| basep | 32 | Smeargle | normal | candidate_unconfirmed_by_index | Exact set, number, name, and finish matched the current index. |
...
| bw4 | 20 | Chandelure | normal | candidate_unconfirmed_by_index | Exact set, number, name, and finish matched the current index. |
...
| bw4 | 74 | Scrafty | normal | candidate_unconfirmed_by_index | Exact set, number, name, and finish matched the current index. |
...
| g1 | 6 | Flareon-EX | normal | set_unmapped | Grookai set_code was not present in the current English Master Index source set map. |
...
| bw6 | 117 | Blend Energy GrassFirePsychicDarkness | normal | candidate_unconfirmed_by_index | Exact set, number, name, and finish matched the current index. |
...
| g1 | 32 | Sylveon-EX | normal | set_unmapped | Grookai set_code was not present in the current English Master Index source set map. |
| g1 | 9 | Raichu | normal | set_unmapped | Grookai set_code was not present in the current English Master Index source set map. |
| g1 | 22 | Diancie | normal | set_unmapped | Grookai set_code was not present in the current English Master Index source set map. |
| g1 | 11 | Wobbuffet | normal | set_unmapped | Grookai set_code was not present in the current English Master Index source set map. |
