...
- audit_status: complete_to_operator_approval_packet_boundary_no_write
...
- main_blocker: Operator approval packet exists, but approval is not recorded and no fresh snapshot or separate guarded execution artifact exists.
