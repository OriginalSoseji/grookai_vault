# PKG-33A Legacy Orphan Species Dependency Readiness V1
...
| metric | value |
| --- | --- |
| package_id | PKG-33A-LEGACY-ORPHAN-SPECIES-DEPENDENCY-READINESS |
| fingerprint | 5106dd72315cea0a3a2aa30c44cd7887a792fd8f8c559e8ba7d3290bbf5ac2b3 |
| target_rows | 16 |
| eligible_rows | 14 |
| blocked_rows | 2 |
| blocking_parent_fk_refs | 8 |
| blocking_child_fk_refs | 0 |
...
| classification | rows |
| --- | --- |
| legacy_orphan_species_child_parent_delete_candidate | 14 |
| blocked_external_dependencies_present | 2 |
...
| --- | --- | --- | --- |
| 68 | Sandshrew | blocked_external_dependencies_present | parent or child has references outside the intentional child/species cleanup scope |
| 84 | Garganacl | blocked_external_dependencies_present | parent or child has references outside the intentional child/species cleanup scope |

## Blocking Parent References

| table | column | count |
| --- | --- | --- |
| public.card_print_price_curves | card_print_id | 2 |
| public.ebay_active_price_snapshots | card_print_id | 2 |
| public.ebay_active_prices_latest | card_print_id | 2 |
| public.pricing_jobs | card_print_id | 2 |
