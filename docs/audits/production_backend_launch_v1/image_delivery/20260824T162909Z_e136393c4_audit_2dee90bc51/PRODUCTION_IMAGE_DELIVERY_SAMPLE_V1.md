...
- Observed: `2026-08-24T16:29:10.151Z`
...
| --- | ---: | ---: | ---: | ---: | ---: |
| Direct Storage HEAD | 3000 | 0 | 0.0000% | 0.0998% | 572.5 ms |
| Direct Storage full body | 100 | 0 | 0.0000% | 2.9513% | 593.0 ms |
| Production web proxy HEAD (anonymous_public) | 100 | 0 | 0.0000% | 2.9513% | 3094.3 ms |

## Boundaries

- Database: one read-only catalog query.
- Storage: authenticated HEAD/GET reads only.
- Web: image-proxy HEAD reads only for the `anonymous_public` release cohort.
