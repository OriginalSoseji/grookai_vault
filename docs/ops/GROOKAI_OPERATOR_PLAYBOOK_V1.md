...
| MTG sealed world | `docs/checkpoints/pricing/PRICING_CHECKPOINT_107_MTG_SEALED_PRICING_REFRESH_AND_RPC_V3_CANDIDATE_READY.md` | Merged-main read-only pricing reconciles 2,149 exact image-eligible rows; image schema, RPC V3, and all writes remain unapplied |
...
`docs/checkpoints/pricing/PRICING_CHECKPOINT_107_MTG_SEALED_PRICING_REFRESH_AND_RPC_V3_CANDIDATE_READY.md`.
