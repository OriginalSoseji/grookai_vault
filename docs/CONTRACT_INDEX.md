...
| MTG_SEALED_TRANSIENT_STORAGE_CANARY_V1 | System-CA repair implemented; live proof pending | docs/contracts/MTG_SEALED_TRANSIENT_STORAGE_CANARY_V1.md — Governs one exact 17-object upload/readback/removal proof; two source-only attempts failed before upload with all paths absent, and verified bundled-plus-system CA trust awaits a new fingerprinted authority |
