...
| MTG_SEALED_SIGNED_IN_CLIENT_ROLLOUT_V1 | Canary passed; production web pending | docs/contracts/MTG_SEALED_SIGNED_IN_CLIENT_ROLLOUT_V1.md — Governs the bounded, authenticated web and Flutter catalog clients, trusted signed-image boundary, 24-row limit, and independent client rollback flags |
