...
| CARD_VISUAL_ARTWORK_GROUPING_V1_1 | Locked | docs/contracts/CARD_VISUAL_ARTWORK_GROUPING_V1_1.md — Preserves exact-image fail-closed grouping while reconciling typographic apostrophes and terminal EX/GX separators without changing meaningful species-name punctuation |
| CARD_VISUAL_SEARCH_PROJECTION_V1 | Active | docs/contracts/CARD_VISUAL_SEARCH_PROJECTION_V1.md — Deterministic evidence-backed subject, scene, and style/composition document construction with exact Tier B guard exclusions and no model, embedding, or database path |
