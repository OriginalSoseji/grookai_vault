...
| LEAGUE_PLACEMENT_STAMP_IDENTITY_RULE_V1 | Active | docs/contracts/LEAGUE_PLACEMENT_STAMP_IDENTITY_RULE_V1.md — Explicit First/Second/Third/Fourth Place Pokemon League stamp wording is parent identity-bearing and must not collapse into generic `league_stamp` |
| REGIONAL_CHAMPIONSHIP_STAMP_IDENTITY_RULE_V1 | Active | docs/contracts/REGIONAL_CHAMPIONSHIP_STAMP_IDENTITY_RULE_V1.md — Explicit Regional Championships and Regional Championships Staff tournament wording is parent identity-bearing; Staff/non-Staff stay separate, crosshatch remains evidence/display metadata unless active finish taxonomy promotes it |
| CHAMPIONSHIP_STAMP_IDENTITY_RULE_V1 | Active | docs/contracts/CHAMPIONSHIP_STAMP_IDENTITY_RULE_V1.md — Explicit City, State, National, and Staff Championship wording is parent identity-bearing and must not collapse into generic `league_stamp` |
| PLAY_POKEMON_PLAYER_REWARDS_STAMP_IDENTITY_RULE_V1 | Active | docs/contracts/PLAY_POKEMON_PLAYER_REWARDS_STAMP_IDENTITY_RULE_V1.md — Play! Pokemon, Pokemon League, and Player Rewards stamped/crosshatch rows use the most specific source-backed printed identity while crosshatch remains evidence/display metadata |
