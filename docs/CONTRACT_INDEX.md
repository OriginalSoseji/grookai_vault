...
| MTG_SEALED_AUTHENTICATED_IMAGE_READ_V1_CANDIDATE | Offline candidate | docs/contracts/MTG_SEALED_AUTHENTICATED_IMAGE_READ_V1_CANDIDATE.md — Defines the unapplied authenticated-only Storage SELECT boundary for active byte-verified MTG sealed images with matching fresh exact price authority and no anonymous access |
