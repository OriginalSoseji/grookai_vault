...
| MTG_SEALED_TRANSIENT_STORAGE_CANARY_V1 | Implemented; unexecuted | docs/contracts/MTG_SEALED_TRANSIENT_STORAGE_CANARY_V1.md — Governs one exact 17-object upload/readback/removal proof with double collision checks, write-ahead ownership, interruption recovery, final absence, and zero database or durable state |
