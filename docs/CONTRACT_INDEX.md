...
| MTG_SEALED_TRANSIENT_STORAGE_CANARY_V1 | Repair implemented; live proof pending | docs/contracts/MTG_SEALED_TRANSIENT_STORAGE_CANARY_V1.md — Governs one exact 17-object upload/readback/removal proof; first source transport attempt failed before upload with all paths absent, and the bounded retry repair awaits a new fingerprinted authority |
