...
/// - ex5.5 -> ex5pt5   (Trainer Kit style)
/// - popX  -> series 'pop'
String? tcgdexImageUrl(String setCode, String number) {
  ...
  // Normalize set slug for tcgdex
  final s = raw.replaceAll('.5', 'pt5'); // ex5.5 -> ex5pt5 etc.
  ...
  String seriesFor(String sc) {
    ...
    if (sc == 'lc') return 'lc';
    // NP promos are inconsistent on tcgdex; if called, attempt a generic series
