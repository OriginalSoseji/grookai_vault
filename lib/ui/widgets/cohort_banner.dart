...
class _CohortBannerState extends State<CohortBanner> {
  ...
  Future<void> _load() async {
    ...
    setState(() => _hide = p.getBool('hide_scanner_rollout_banner') == true);
  }

  Future<void> _dismiss() async {
    final p = await SharedPreferences.getInstance();
    await p.setBool('hide_scanner_rollout_banner', true);
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          const Expanded(
            child: Text(
              "Scanner is rolling out gradually. You're not in the beta cohort yet.",
            ),
          ),
          TextButton(
            onPressed: () async {
              ...
              final url =
                  'mailto:support@grookai.example?subject=Scanner%20Beta%20Access';
