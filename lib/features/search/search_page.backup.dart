...
Widget thumb(String? url, {double size = 56}) {
  ...
  return ClipRRect(
    borderRadius: BorderRadius.circular(8),
    child: FixCardImage(setCode: result.set_code ?? result.setCode ?? '', number: result.number ?? '', width: 64, height: 90, fit: BoxFit.cover, borderRadius: BorderRadius.circular(8)) ,
        width: size,
        height: size,
        alignment: Alignment.center,
        decoration: BoxDecoration(
