...
function buildAcquisitionRunRow(fetchArtifact, generatedAt) {
  ...
  return {
    ...
    status: "completed",
    requested_call_ceiling: fetchArtifact.summary?.provider_call_ceiling ?? fetchArtifact.summary?.approved_request_count ?? 0,
    consumed_call_count: fetchArtifact.summary?.attempted_request_count ?? 0,
    requested_listing_ceiling: (fetchArtifact.summary?.provider_call_ceiling ?? fetchArtifact.summary?.approved_request_count ?? 0) * 200,
