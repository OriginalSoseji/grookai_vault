...
export const MARKET_EVIDENCE_SOURCE_REGISTRY_V1 = Object.freeze([
  ...
  Object.freeze({
    ...
    can_publish_price_directly: false,
    requires_review_before_truth: true,
    notes: 'Reference pricing can corroborate market evidence, but it is not Grookai market truth.',
  }),
  Object.freeze({
  ...
  Object.freeze({
    source: 'justtcg_reference',
    label: 'JustTCG Reference',
    source_type: 'reference_price',
    acquisition_mode: 'existing_reference_lane',
    pricing_lane: 'reference',
    truth_role: 'reference_signal',
    can_publish_price_directly: false,
    requires_review_before_truth: false,
    notes: 'Existing reference lane. It must remain separate from listing-level market truth.',
  }),
  Object.freeze({
