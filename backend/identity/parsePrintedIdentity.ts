export type ParsedIdentitySource = 'external_id' | 'raw_number';

export type ParsedIdentity = {
  printed_identity: string;
  number_plain: string | null;
  number_suffix: string | null;
  source: ParsedIdentitySource;
};
...
export function normalizePrintedName(
...
export function parseExternalId(externalId: string): ParsedIdentity | null {
...
export function parseRawNumber(raw: string): ParsedIdentity | null {
