...
const PHASE = 'XY3_POST_NORMALIZATION_DRIFT_REPAIR_V1';
...
const TARGET_ROW_ID = '5862d23e-8526-4055-baf2-cc478ce02ea9';
const TARGET_GV_ID = 'GV-PK-FFI-55A';
const TARGET_OLD_NAME = 'M Lucario EX';
const TARGET_NEW_NAME = 'M Lucario-EX';
const EXPECTED_CANONICAL_COUNT = 114;
...
function assertDriftRows(driftRows) {
  ...
  assertEqual(row.number, '55a', 'TARGET_NUMBER_DRIFT');
  assertEqual(row.number_plain, '55', 'TARGET_NUMBER_PLAIN_DRIFT');
...
async function run() {
  ...
  const client = new Client({
    ...
    application_name: `xy3_post_normalization_drift_repair_v1:${MODE}`,
  });
