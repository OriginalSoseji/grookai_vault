...
For any schema or migration task, Codex must use `.codex/prompts/MIGRATION_TASK_PROMPT_V1.md` as the baseline workflow. Migration work is not allowed to skip:
- target print
- audit
