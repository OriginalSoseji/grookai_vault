...
-- Optional:
-- create index if not exists idx_latest_prices_dims
--   on public.latest_prices (condition, grade_agency, grade_value);
...
-- do NOT touch latest_prices here; thatâ€™s handled in the MV migration
