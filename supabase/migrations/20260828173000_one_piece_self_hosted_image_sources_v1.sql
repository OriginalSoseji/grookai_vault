...
comment on constraint card_prints_image_source_check
  ...
  'Allowed original image evidence providers. Storage location remains separately governed; One Piece exact TCGPlayer products and exact Bandai base artwork are explicit authorities.';
