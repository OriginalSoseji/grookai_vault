create index concurrently if not exists tcgcsv_source_artifacts_sync_run_kind_latest_idx on public.tcgcsv_source_artifacts (sync_run_id, artifact_kind, created_at desc, id desc) include (sha256);
