...
'LOCAL_COMMUNITY_FEED_V1 authenticated nearby feed RPC. Uses auth.uid(), emits no raw user IDs or exact location, excludes blocks/mutes, and suppresses UUID-backed storage paths.';
