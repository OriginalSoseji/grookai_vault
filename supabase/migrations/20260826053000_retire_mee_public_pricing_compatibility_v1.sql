...
--
-- Production V1 pricing is governed exclusively by the authenticated
-- TCGPlayer Market read model. Preserve the obsolete compatibility view's
-- column shape for database dependants, but prevent it from publishing MEE,
-- modeled, inferred, eBay-ask, or fallback values.
