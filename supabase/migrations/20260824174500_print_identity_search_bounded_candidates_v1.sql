-- PRINT_IDENTITY_SEARCH_BOUNDED_CANDIDATES_V1
-- Bound high-priority name expansion to the requested page and skip lower
-- ranked candidate families when those name results already fill the page.
...
comment on function public.search_print_identity_v1(
  ...
  'PRINT_IDENTITY_SEARCH_BOUNDED_CANDIDATES_V1. Preserves V1 output and release visibility while bounding high-priority names and skipping lower-ranked candidate families only after the requested page is satisfied.';
