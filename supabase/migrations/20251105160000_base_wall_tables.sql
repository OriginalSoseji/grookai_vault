-- Promotion: base wall tables from _hold/20251104_base_wall_tables.sql
-- Intent: Create public.listings and public.listing_images so downstream views/MVs work.
-- Note: Content copied verbatim from _hold; additive/idempotent.
...
-- NOTE: RLS policies are applied separately (see 20251104100500_listings_rls.sql).
