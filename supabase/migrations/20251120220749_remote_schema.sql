alter table "public"."external_mappings" drop constraint "external_mappings_unique_per_source";
...
drop index if exists "public"."external_mappings_unique_per_source";
