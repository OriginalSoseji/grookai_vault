...
-- Apply request-role catalog visibility before bounding high-priority names or
-- deciding that lower-ranked candidate families can be skipped.
...
comment on function public.search_print_identity_v1(
  ...
  'PRINT_IDENTITY_SEARCH_VISIBLE_BOUND_V1. Preserves V1 output while applying request-role catalog visibility before bounding high-priority names and deciding whether lower-ranked candidate families can be skipped.';
