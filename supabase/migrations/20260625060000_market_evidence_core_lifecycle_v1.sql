-- MEE_CORE_LIFECYCLE_SCHEMA_V1 local migration candidate.
-- Purpose: minimum provider-agnostic lifecycle state and transition history layer.
...
select
  ...
  false::boolean as rollback_only;
