...
revoke all on public.sealed_product_families from public, anon, authenticated;
revoke all on public.sealed_product_variants from public, anon, authenticated;
revoke all on public.sealed_product_candidates from public, anon, authenticated;
revoke all on public.sealed_product_candidate_reviews from public, anon, authenticated;
revoke all on public.sealed_product_source_mappings from public, anon, authenticated;
revoke all on public.sealed_product_variant_evidence from public, anon, authenticated;
revoke all on public.sealed_product_pricing_lane_qualifications from public, anon, authenticated;
revoke all on public.sealed_product_releases from public, anon, authenticated;
revoke all on public.sealed_product_release_members from public, anon, authenticated;
revoke all on public.sealed_product_release_pointer from public, anon, authenticated;
revoke all on function public.sealed_product_reject_row_mutation_v1() from public, anon, authenticated;
revoke all on function public.sealed_product_guard_release_mutation_v1() from public, anon, authenticated;
revoke all on function public.sealed_product_guard_release_member_insert_v1() from public, anon, authenticated;
revoke all on function public.sealed_product_freeze_release_v1(uuid, text, uuid) from public, anon, authenticated;
revoke all on function public.sealed_product_set_active_release_v1(uuid, uuid, uuid) from public, anon, authenticated;
