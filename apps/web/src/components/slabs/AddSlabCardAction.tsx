  ...
  return (
    <div className="space-y-4">
      ...
      {isOpen ? (
        ...
        >
          <div
            className="w-full max-w-2xl rounded-[2rem] border border-slate-200 bg-white p-6 shadow-2xl sm:p-7"
              ...
              <div className="rounded-[1.5rem] border border-slate-200 bg-slate-50 px-4 py-4">
                <label className="flex items-start gap-3">
                  ...
                  <span className="text-sm leading-6 text-slate-700">
                    This slab will be attached to this exact card in your vault. I confirm the certification number is correct.
                  </span>
                </label>
              </div>
