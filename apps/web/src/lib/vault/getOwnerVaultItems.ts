  ...
  return (rows ?? [])
    ...
    .map((row) => {
      return {
        ...
        canonical_image_status: row.canonical_image_status,
        canonical_image_note: row.canonical_image_note,
        canonical_display_image_url: row.canonical_display_image_url,
        canonical_display_image_kind: row.canonical_display_image_kind,
