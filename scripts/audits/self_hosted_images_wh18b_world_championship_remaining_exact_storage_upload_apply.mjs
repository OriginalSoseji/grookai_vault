...
const SOURCE_SUMMARY_JSON = path.join(OUTPUT_DIR, 'self_hosted_images_wh18a_world_championship_remaining_source_acquisition_summary_v1.json');
...
const PLAN_JSON = path.join(OUTPUT_DIR, 'self_hosted_images_wh18b_world_championship_remaining_exact_storage_upload_apply_plan_v1.json');
const PLAN_MD = path.join(OUTPUT_DIR, 'self_hosted_images_wh18b_world_championship_remaining_exact_storage_upload_apply_plan_v1.md');
const RESULT_JSONL = path.join(OUTPUT_DIR, 'self_hosted_images_wh18b_world_championship_remaining_exact_storage_upload_apply_result_v1.jsonl');
const RESULT_JSON = path.join(OUTPUT_DIR, 'self_hosted_images_wh18b_world_championship_remaining_exact_storage_upload_apply_result_v1.json');
const RESULT_MD = path.join(OUTPUT_DIR, 'self_hosted_images_wh18b_world_championship_remaining_exact_storage_upload_apply_result_v1.md');
const PACKAGE_ID = 'IMG-HOST-WH-18B-WORLD-CHAMPIONSHIP-REMAINING-EXACT-STORAGE-UPLOAD-APPLY';
...
async function buildPlan(args, summary, manifestRows, uploadObjects) {
  ...
  if (summary.package_id !== 'IMG-HOST-WH-18A-WORLD-CHAMPIONSHIP-REMAINING-SOURCE-ACQUISITION') {
