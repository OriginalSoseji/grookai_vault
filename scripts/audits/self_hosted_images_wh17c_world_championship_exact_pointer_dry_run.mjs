...
const UPLOAD_RESULT_JSON = path.join(OUTPUT_DIR, 'self_hosted_images_wh17b_world_championship_exact_storage_upload_apply_result_v1.json');
const UPLOAD_RESULT_JSONL = path.join(OUTPUT_DIR, 'self_hosted_images_wh17b_world_championship_exact_storage_upload_apply_result_v1.jsonl');
const PLAN_JSONL = path.join(OUTPUT_DIR, 'self_hosted_images_wh17c_world_championship_exact_pointer_plan_v1.jsonl');
const SUMMARY_JSON = path.join(OUTPUT_DIR, 'self_hosted_images_wh17c_world_championship_exact_pointer_dry_run_summary_v1.json');
const SUMMARY_MD = path.join(OUTPUT_DIR, 'self_hosted_images_wh17c_world_championship_exact_pointer_dry_run_summary_v1.md');
const PACKAGE_ID = 'IMG-HOST-WH-17C-WORLD-CHAMPIONSHIP-EXACT-POINTER-DRY-RUN';
...
async function main() {
  ...
  const stopFindings = [];
  if (uploadResult.package_id !== 'IMG-HOST-WH-17B-WORLD-CHAMPIONSHIP-EXACT-STORAGE-UPLOAD-APPLY') {
