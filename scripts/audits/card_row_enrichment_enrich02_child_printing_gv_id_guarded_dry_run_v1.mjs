...
const OUTPUT_JSON = path.join(OUTPUT_DIR, 'enrich02_child_printing_gv_id_guarded_dry_run_v1.json');
const OUTPUT_MD = path.join(OUTPUT_DIR, 'enrich02_child_printing_gv_id_guarded_dry_run_v1.md');
...
async function main() {
  ...
  try {
    ...
    const report = {
      version: 'ENRICH02_CHILD_PRINTING_GV_ID_GUARDED_DRY_RUN_V1',
      package_id: PACKAGE_ID,
