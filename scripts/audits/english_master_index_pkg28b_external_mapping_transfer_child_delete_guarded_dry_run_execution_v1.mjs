...
const OUTPUT_JSON = path.join(AUDIT_DIR, 'english_master_index_pkg28b_external_mapping_transfer_child_delete_guarded_dry_run_execution_v1.json');
const OUTPUT_MD = path.join(AUDIT_DIR, 'english_master_index_pkg28b_external_mapping_transfer_child_delete_guarded_dry_run_execution_v1.md');
...
function buildMarkdown(report) {
  return `# PKG-28B Guarded Dry-Run Execution V1
