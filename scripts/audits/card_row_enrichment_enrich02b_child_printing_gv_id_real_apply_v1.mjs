...
function validateDryRun(dryRun, packageFingerprint) {
  ...
  if (dryRun.execution?.inside_transaction_proof?.updated_rows !== EXPECTED_TARGET_ROWS) findings.push('dry_run_update_count_mismatch');
  return findings;
}
...
async function main() {
  ...
  try {
    ...
    const report = {
      version: 'ENRICH02B_CHILD_PRINTING_GV_ID_REAL_APPLY_V1',
      package_id: PACKAGE_ID,
