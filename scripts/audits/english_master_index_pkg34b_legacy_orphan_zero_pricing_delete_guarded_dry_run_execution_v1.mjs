...
const OUTPUT_JSON = path.join(AUDIT_DIR, 'english_master_index_pkg34b_legacy_orphan_zero_pricing_delete_guarded_dry_run_execution_v1.json');
const OUTPUT_MD = path.join(AUDIT_DIR, 'english_master_index_pkg34b_legacy_orphan_zero_pricing_delete_guarded_dry_run_execution_v1.md');
...
function buildMarkdown(report) {
  return `# PKG-34B Legacy Orphan Zero Pricing Delete Guarded Dry-Run Execution V1

Rollback-only execution proof for PKG-34B.
