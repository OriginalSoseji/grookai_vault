...
const PACKAGE_ID = "MEE-CORE-INTERNAL-REVIEW-ACTION-FUNCTION-LOW-SIGNAL-100-BATCH-PLAN-V1";
const REVIEW_ACTOR = "system_low_signal_100_batch_plan";
...
const note = "MEE core 100-row low_signal_monitor batch proof: confirm monitor_only remains internal only.";
...
const applySql = `-- MEE_CORE_INTERNAL_REVIEW_ACTION_FUNCTION_LOW_SIGNAL_100_BATCH_PLAN_V1 apply candidate.
...
const rollbackSql = `-- MEE_CORE_INTERNAL_REVIEW_ACTION_FUNCTION_LOW_SIGNAL_100_BATCH_PLAN_V1 rollback candidate.
...
const preflightSql = `-- MEE_CORE_INTERNAL_REVIEW_ACTION_FUNCTION_LOW_SIGNAL_100_BATCH_PLAN_V1 preflight SQL.
...
const readbackSql = `-- MEE_CORE_INTERNAL_REVIEW_ACTION_FUNCTION_LOW_SIGNAL_100_BATCH_PLAN_V1 readback SQL.
...
const report = {
  ...
  artifacts: {
    ...
    apply_sql: "docs/sql/mee_core_internal_review_action_function_low_signal_100_batch_v1_apply_candidate.sql",
    rollback_sql: "docs/sql/mee_core_internal_review_action_function_low_signal_100_batch_v1_rollback_candidate.sql",
    readback_sql: "docs/sql/mee_core_internal_review_action_function_low_signal_100_batch_v1_readback.sql",
    preflight_sql: "docs/sql/mee_core_internal_review_action_function_low_signal_100_batch_v1_preflight.sql",
    ...
    plan_md: "docs/plans/market_evidence_engine_v1/MEE_CORE_INTERNAL_REVIEW_ACTION_FUNCTION_LOW_SIGNAL_100_BATCH_PLAN_V1.md",
  },
  findings: [],
  boundary_proof: {
    db_writes: false,
...
const planMd = `# MEE Core Internal Review Action Function Low Signal 100 Batch Plan V1
...
writeFileSync(path.join(PLAN_DIR, "MEE_CORE_INTERNAL_REVIEW_ACTION_FUNCTION_LOW_SIGNAL_100_BATCH_PLAN_V1.md"), planMd);
writeFileSync(path.join(SQL_DIR, "mee_core_internal_review_action_function_low_signal_100_batch_v1_apply_candidate.sql"), applySql);
writeFileSync(path.join(SQL_DIR, "mee_core_internal_review_action_function_low_signal_100_batch_v1_rollback_candidate.sql"), rollbackSql);
writeFileSync(path.join(SQL_DIR, "mee_core_internal_review_action_function_low_signal_100_batch_v1_readback.sql"), readbackSql);
writeFileSync(path.join(SQL_DIR, "mee_core_internal_review_action_function_low_signal_100_batch_v1_preflight.sql"), preflightSql);
