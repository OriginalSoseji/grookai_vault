...
const DRY_RUN_JSON = path.join(AUDIT_DIR, 'english_master_index_pkg17e3_stamped_active_finish_parent_insert_guarded_dry_run_v1.json');
const OUTPUT_JSON = path.join(AUDIT_DIR, 'english_master_index_pkg17e3_stamped_active_finish_parent_insert_real_apply_v1.json');
const OUTPUT_MD = path.join(AUDIT_DIR, 'english_master_index_pkg17e3_stamped_active_finish_parent_insert_real_apply_v1.md');

const PACKAGE_ID = 'PKG-17E3-STAMPED-ACTIVE-FINISH-PARENT-INSERTS';
const CREATED_BY = 'pkg17e3_stamped_active_finish_parent_insert_real_apply_v1';
const EXPECTED_PACKAGE_FINGERPRINT = '58d86cb908c60697280c5d8080112fecb8c99807c37afd4752c6bf6fe41dd979';
const EXPECTED_DRY_RUN_PROOF = '6439e6c1f6c70c16d35d2d3f35c686e92c75b2e96afdfaa04916a89881623ae2';
const EXPECTED_PRE_APPLY_HASH = '9086cabe1bfdf4789bf21cdab0276cb31459a2ae6df2f658691f037a453ea4fb';
const EXPECTED_TARGET_COUNT = 4;
const APPROVAL_TEXT = 'Approve real PKG-17E3-STAMPED-ACTIVE-FINISH-PARENT-INSERTS apply only. Fingerprint: 58d86cb908c60697280c5d8080112fecb8c99807c37afd4752c6bf6fe41dd979. Scope: 4 stamped parent inserts, 4 identity inserts, 4 child printing inserts; finishes cosmos=4; sets sv06.5=1, swsh12.5=3. Dry-run proof: 9086cabe1bfdf4789bf21cdab0276cb31459a2ae6df2f658691f037a453ea4fb == 9086cabe1bfdf4789bf21cdab0276cb31459a2ae6df2f658691f037a453ea4fb. No global apply. No migrations. No deletes. No merges. No unsupported cleanup.';
...
function validateDryRun(dryRun) {
  ...
  if (dryRun.execution?.dry_run_status !== 'pkg17e3_completed_rolled_back_no_durable_change') findings.push('dry_run_status_not_passed');
...
async function applyPackage(client, targets, fingerprint) {
  ...
  try {
    ...
    return {
      apply_status: 'pkg17e3_real_apply_committed',
      guard: guardRow,
      proof: proof.rows[0],
      write_counts: {
...
function renderMarkdown(report) {
  return `# PKG-17E3 Stamped Active Finish Parent Insert Real Apply V1

Approved real apply for PKG-17E3 only.
...
${markdownTable(
    ['set', 'number', 'card', 'stamp_label', 'variant', 'modifier', 'finish'],
...
async function main() {
  ...
  const report = {
    ...
    version: 'english_master_index_pkg17e3_stamped_active_finish_parent_insert_real_apply_v1',
