...
const APPLY_JSON = path.join(AUDIT_DIR, 'english_master_index_pkg17n_skarmory_league_reverse_real_apply_v1.json');
const OUTPUT_JSON = path.join(AUDIT_DIR, 'english_master_index_pkg17n_skarmory_league_reverse_post_apply_reconciliation_v1.json');
const OUTPUT_MD = path.join(AUDIT_DIR, 'english_master_index_pkg17n_skarmory_league_reverse_post_apply_reconciliation_v1.md');
...
function buildMarkdown(report) {
  return `# PKG-17N Skarmory League Reverse Post-Apply Reconciliation V1

Read-only post-apply verification for PKG-17N.
...
async function main() {
  ...
  const report = {
    ...
    version: 'english_master_index_pkg17n_skarmory_league_reverse_post_apply_reconciliation_v1',
