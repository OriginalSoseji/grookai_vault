...
const DRY_RUN_JSON = path.join(OUTPUT_DIR, 'enrich17a_chaos_rising_parent_gv_id_guarded_dry_run_v1.json');
const OUTPUT_JSON = path.join(OUTPUT_DIR, 'enrich17a_chaos_rising_parent_gv_id_real_apply_v1.json');
const OUTPUT_MD = path.join(OUTPUT_DIR, 'enrich17a_chaos_rising_parent_gv_id_real_apply_v1.md');
...
const EXPECTED_FINGERPRINT = '73c20cf43f85043a8cf6bb5f1cf0160842224b9e83e6948e64675219d000bbcd';
const EXPECTED_DRY_RUN_PROOF = 'd9e2e75b390ace20abf619b78e2f0a2b115a9f7cc23a2fc0caf249273ae4bd9d';
const EXPECTED_TARGET_ROWS = 122;
const APPROVAL_TEXT = 'Approve real ENRICH-17A-CHAOS-RISING-PARENT-GV-ID-BACKFILL apply only. Fingerprint: 73c20cf43f85043a8cf6bb5f1cf0160842224b9e83e6948e64675219d000bbcd. Scope: 122 Chaos Rising parent card_print gv_id updates using source-backed CRI namespace. Dry-run proof: d9e2e75b390ace20abf619b78e2f0a2b115a9f7cc23a2fc0caf249273ae4bd9d == d9e2e75b390ace20abf619b78e2f0a2b115a9f7cc23a2fc0caf249273ae4bd9d. No child writes. No identity writes. No external mapping writes. No species writes. No deletes. No merges. No migrations. No image writes. No global apply.';
...
async function applyPackage(client, targets) {
  ...
  try {
    ...
    if (
      ...
      preflight.source_abbrev_mismatch_count !== 0 ||
...
async function main() {
  ...
  try {
    ...
    const report = {
      version: 'ENRICH17A_CHAOS_RISING_PARENT_GV_ID_REAL_APPLY_V1',
      package_id: PACKAGE_ID,
    ...
    await writeText(OUTPUT_MD, [
      '# ENRICH-17A Chaos Rising Parent GV-ID Real Apply V1',
      '',
      `Package: \`${PACKAGE_ID}\``,
      '',
      '## Result',
