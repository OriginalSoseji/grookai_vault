...
const APPLY_PLAN_JSON = path.join(
  OUTPUT_DIR,
  'self_hosted_images_wh09k_world_championship_energy_template_pointer_apply_plan_v1.json',
);
const APPLY_PLAN_MD = path.join(
  OUTPUT_DIR,
  'self_hosted_images_wh09k_world_championship_energy_template_pointer_apply_plan_v1.md',
);
const APPLY_RESULT_JSON = path.join(
  OUTPUT_DIR,
  'self_hosted_images_wh09k_world_championship_energy_template_pointer_apply_result_v1.json',
);
const APPLY_RESULT_MD = path.join(
  OUTPUT_DIR,
  'self_hosted_images_wh09k_world_championship_energy_template_pointer_apply_result_v1.md',
);

const PACKAGE_ID = 'IMG-HOST-WH-09K-WORLD-CHAMPIONSHIP-ENERGY-TEMPLATE-POINTER-APPLY';
const SOURCE_DRY_RUN_PACKAGE_ID = 'IMG-HOST-WH-09J-WORLD-CHAMPIONSHIP-ENERGY-TEMPLATE-POINTER-DRY-RUN';
const APPROVED_SOURCE_FINGERPRINT = 'b3bc06b4bb35d156eb8b8358ee64c960813bc7b687e3689e763c3677decd500f';
const APPROVED_PLAN_FILE_HASH = 'bb97f44028f5168b692215dffc77a51894d9e17c3855a26d7d425a06225865a1';
const EXPECTED_UPDATE_COUNT = 83;
