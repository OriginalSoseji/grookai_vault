...
const DRY_RUN_JSON = path.join(AUDIT_DIR, 'english_master_index_pkg40b_residual_stamped_identity_backfill_guarded_dry_run_v1.json');
const OUTPUT_JSON = path.join(AUDIT_DIR, 'english_master_index_pkg40b_residual_stamped_identity_backfill_real_apply_v1.json');
const OUTPUT_MD = path.join(AUDIT_DIR, 'english_master_index_pkg40b_residual_stamped_identity_backfill_real_apply_v1.md');

const PACKAGE_ID = 'PKG-40B-RESIDUAL-STAMPED-IDENTITY-BACKFILL';
const EXPECTED_PACKAGE_FINGERPRINT = 'b8fc2054abeb140a34ae3cb27f5227969f0eba2c1a5f1443302dc7e982bf572d';
const EXPECTED_DRY_RUN_PROOF_HASH = '5814968e38148b6d72db2a1e142bc209b3612180ff227b676b1577e00a74078d';
...
function renderMarkdown(report) {
  return `# PKG-40B Residual Stamped Identity Backfill Real Apply V1

Real apply for the explicitly approved PKG-40B scope.
...
const report = {
  ...
  version: 'english_master_index_pkg40b_residual_stamped_identity_backfill_real_apply_v1',
  package_id: PACKAGE_ID,
