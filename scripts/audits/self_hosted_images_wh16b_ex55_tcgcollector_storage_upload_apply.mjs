...
const SOURCE_SUMMARY_JSON = path.join(OUTPUT_DIR, 'self_hosted_images_wh16a_ex55_tcgcollector_upload_dry_run_summary_v1.json');
const MANIFEST_JSONL = path.join(OUTPUT_DIR, 'self_hosted_images_wh16a_ex55_tcgcollector_upload_manifest_v1.jsonl');
const PLAN_JSON = path.join(OUTPUT_DIR, 'self_hosted_images_wh16b_ex55_tcgcollector_storage_upload_apply_plan_v1.json');
const PLAN_MD = path.join(OUTPUT_DIR, 'self_hosted_images_wh16b_ex55_tcgcollector_storage_upload_apply_plan_v1.md');
const RESULT_JSONL = path.join(OUTPUT_DIR, 'self_hosted_images_wh16b_ex55_tcgcollector_storage_upload_apply_result_v1.jsonl');
const RESULT_JSON = path.join(OUTPUT_DIR, 'self_hosted_images_wh16b_ex55_tcgcollector_storage_upload_apply_result_v1.json');
const RESULT_MD = path.join(OUTPUT_DIR, 'self_hosted_images_wh16b_ex55_tcgcollector_storage_upload_apply_result_v1.md');
const PACKAGE_ID = 'IMG-HOST-WH-16B-EX55-TCGCOLLECTOR-STORAGE-UPLOAD-APPLY';
const USER_AGENT = 'Grookai WH16B EX55 Image Upload Apply/1.0';
