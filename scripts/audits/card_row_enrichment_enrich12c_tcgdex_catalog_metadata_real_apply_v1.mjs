...
const DRY_RUN_JSON = path.join(OUTPUT_DIR, 'enrich12c_tcgdex_catalog_metadata_guarded_dry_run_v1.json');
const OUTPUT_JSON = path.join(OUTPUT_DIR, 'enrich12c_tcgdex_catalog_metadata_real_apply_v1.json');
const OUTPUT_MD = path.join(OUTPUT_DIR, 'enrich12c_tcgdex_catalog_metadata_real_apply_v1.md');

const PACKAGE_ID = 'ENRICH-12C-TCGDEX-CATALOG-METADATA-BACKFILL';
const EXPECTED_FINGERPRINT = '9db306d247dbcfbe8c823ba27098821f7e47f2d630fcfc6547350520df75e388';
const EXPECTED_DRY_RUN_PROOF = '8f62b5ff6513a7975fe46c13d13cee8e09dbdb0ee13b2936e351dd02e4127a62';
const EXPECTED_TARGET_ROWS = 52;
const APPROVAL_TEXT = 'Approve real ENRICH-12C-TCGDEX-CATALOG-METADATA-BACKFILL apply only. Fingerprint: 9db306d247dbcfbe8c823ba27098821f7e47f2d630fcfc6547350520df75e388. Scope: 52 null-only card_prints catalog metadata updates from exact active TCGdex source mappings. Dry-run proof: 8f62b5ff6513a7975fe46c13d13cee8e09dbdb0ee13b2936e351dd02e4127a62 == 8f62b5ff6513a7975fe46c13d13cee8e09dbdb0ee13b2936e351dd02e4127a62. No non-null overwrites. No child writes. No identity writes. No external mapping writes. No species writes. No deletes. No merges. No migrations. No image writes. No global apply.';
