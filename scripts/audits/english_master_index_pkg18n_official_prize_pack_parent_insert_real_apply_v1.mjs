...
const DRY_RUN_JSON = path.join(AUDIT_DIR, 'english_master_index_pkg18n_official_prize_pack_parent_insert_guarded_dry_run_v1.json');
const OUTPUT_JSON = path.join(AUDIT_DIR, 'english_master_index_pkg18n_official_prize_pack_parent_insert_real_apply_v1.json');
const OUTPUT_MD = path.join(AUDIT_DIR, 'english_master_index_pkg18n_official_prize_pack_parent_insert_real_apply_v1.md');

const PACKAGE_ID = 'PKG-18N-OFFICIAL-PRIZE-PACK-PARENT-INSERTS';
const CREATED_BY = 'pkg18n_official_prize_pack_parent_insert_real_apply_v1';
const EXPECTED_PACKAGE_FINGERPRINT = '6d1519947deb1aa373712ba023b58d9952612c21068975ad90025de084c33621';
const EXPECTED_DRY_RUN_PROOF = '9694d8b85b8ce27759b0b3c5a7425a2e1be187a1c7b0fecae7a38f94b6a337d0';
const EXPECTED_PRE_APPLY_HASH = '7929932f5c1ad760da1f09142b98bbc3cea2aebacb604788d3d4a8c526bf3037';
const EXPECTED_TARGET_COUNT = 15;
const APPROVAL_TEXT = `Approve real PKG-18N-OFFICIAL-PRIZE-PACK-PARENT-INSERTS apply only. Fingerprint: 6d1519947deb1aa373712ba023b58d9952612c21068975ad90025de084c33621. Scope: 15 stamped parent inserts, 15 identity inserts, 15 child printing inserts; finishes normal=15; stamp labels Prize Pack Stamp=15; sets swsh5=6, swsh6=5, swsh7=2, swsh9=2. Dry-run proof: 7929932f5c1ad760da1f09142b98bbc3cea2aebacb604788d3d4a8c526bf3037 == 7929932f5c1ad760da1f09142b98bbc3cea2aebacb604788d3d4a8c526bf3037. No global apply. No migrations. No deletes. No merges. No unsupported cleanup.`;
...
function validateDryRun(dryRun) {
  ...
  if (dryRun.execution?.dry_run_status !== 'pkg18n_completed_rolled_back_no_durable_change') findings.push('dry_run_status_not_passed');
...
async function applyPackage(client, targets, fingerprint) {
  ...
  try {
    ...
    return {
      apply_status: 'pkg18n_real_apply_committed',
      guard: guardRow,
      proof: proof.rows[0],
      write_counts: {
...
function renderMarkdown(report) {
  ...
  return `# PKG-18N Official Prize Pack Parent Insert Real Apply V1

Approved real apply for official-Pokemon-PDF-backed Prize Pack stamped parent identity inserts.
...
async function main() {
  ...
  const report = {
    ...
    version: 'english_master_index_pkg18n_official_prize_pack_parent_insert_real_apply_v1',
