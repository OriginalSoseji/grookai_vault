...
const OUTPUT_MD = path.join(
  AUDIT_DIR,
  'english_master_index_dv1_regional_championship_guarded_dry_run_v1.md',
);

const PACKAGE_ID = 'DV1-REGIONAL-CHAMPIONSHIP-STAMP-PARENT-INSERTS';
const CREATED_BY = 'english_master_index_dv1_regional_championship_guarded_dry_run_v1';
...
function buildMarkdown(report) {
  return `# DV1 Regional Championship Guarded Dry-Run V1
...
async function main() {
  ...
  try {
    ...
    const report = {
      ...
      version: 'english_master_index_dv1_regional_championship_guarded_dry_run_v1',
      package_id: PACKAGE_ID,
