...
const SOURCE_SUMMARY_JSON = path.join(
  OUTPUT_DIR,
  'self_hosted_images_wh09d_world_championship_residual_pointer_dry_run_summary_v1.json',
);
const SOURCE_PLAN_JSONL = path.join(
  OUTPUT_DIR,
  'self_hosted_images_wh09d_world_championship_residual_pointer_plan_v1.jsonl',
);
const APPLY_PLAN_JSON = path.join(
  OUTPUT_DIR,
  'self_hosted_images_wh09e_world_championship_residual_pointer_apply_plan_v1.json',
);
const APPLY_PLAN_MD = path.join(
  OUTPUT_DIR,
  'self_hosted_images_wh09e_world_championship_residual_pointer_apply_plan_v1.md',
);
const APPLY_RESULT_JSON = path.join(
  OUTPUT_DIR,
  'self_hosted_images_wh09e_world_championship_residual_pointer_apply_result_v1.json',
);
const APPLY_RESULT_MD = path.join(
  OUTPUT_DIR,
  'self_hosted_images_wh09e_world_championship_residual_pointer_apply_result_v1.md',
);

const PACKAGE_ID = 'IMG-HOST-WH-09E-WORLD-CHAMPIONSHIP-RESIDUAL-POINTER-APPLY';
const SOURCE_DRY_RUN_PACKAGE_ID = 'IMG-HOST-WH-09D-WORLD-CHAMPIONSHIP-RESIDUAL-POINTER-DRY-RUN';
const APPROVED_SOURCE_FINGERPRINT = '0fba141bd28ccf216544c8dd7f678a0ca757bb7a928524ed3848fde4e01532ff';
const APPROVED_PLAN_FILE_HASH = 'a5485de561480e83c6c7bb7eb50d15ab2a5c8293c7ab684749d0932725f42555';
const EXPECTED_UPDATE_COUNT = 244;
