...
const INPUT_JSON = path.join(OUTPUT_DIR, 'image_truth_img04a_reverseholo_representative_missing_display_dry_run_v1.json');
const OUTPUT_JSON = path.join(OUTPUT_DIR, 'image_truth_img04b_reverseholo_representative_storage_readiness_v1.json');
const OUTPUT_MD = path.join(OUTPUT_DIR, 'image_truth_img04b_reverseholo_representative_storage_readiness_v1.md');
const STORAGE_BUCKET = 'user-card-images';
const PACKAGE_ID = 'IMG-04B-REVERSEHOLO-REPRESENTATIVE-STORAGE-READINESS-NO-UPLOAD';
...
function buildMarkdown(report) {
  return `# Image Truth V1 IMG-04B ReverseHolo Representative Storage Readiness
