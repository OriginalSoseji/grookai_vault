...
const OUTPUT_JSON = path.join(AUDIT_DIR, 'english_master_index_pkg33b_legacy_orphan_species_parent_child_delete_guarded_dry_run_execution_v1.json');
const OUTPUT_MD = path.join(AUDIT_DIR, 'english_master_index_pkg33b_legacy_orphan_species_parent_child_delete_guarded_dry_run_execution_v1.md');
...
function buildMarkdown(report) {
  return `# PKG-33B Legacy Orphan Species Parent Child Delete Guarded Dry-Run Execution V1

Rollback-only execution proof for PKG-33B.
