...
const INPUT_JSON = path.join(OUTPUT_DIR, 'image_truth_img03a_pkmncards_representative_missing_display_dry_run_v1.json');
const OUTPUT_JSON = path.join(OUTPUT_DIR, 'image_truth_img03b_pkmncards_representative_storage_readiness_v1.json');
const OUTPUT_MD = path.join(OUTPUT_DIR, 'image_truth_img03b_pkmncards_representative_storage_readiness_v1.md');
const STORAGE_BUCKET = 'user-card-images';
const PACKAGE_ID = 'IMG-03B-PKMNCARDS-REPRESENTATIVE-STORAGE-READINESS-NO-UPLOAD';
...
function buildMarkdown(report) {
  return `# Image Truth V1 IMG-03B PKMNCards Representative Storage Readiness

This is a no-upload, no-DB-write readiness packet for the IMG-03A PKMNCards representative child-image candidates.
