...
const DRY_RUN_JSON = path.join(OUTPUT_DIR, 'enrich21a_mfb_mee_parent_gv_id_guarded_dry_run_v1.json');
const OUTPUT_JSON = path.join(OUTPUT_DIR, 'enrich21a_mfb_mee_parent_gv_id_real_apply_v1.json');
const OUTPUT_MD = path.join(OUTPUT_DIR, 'enrich21a_mfb_mee_parent_gv_id_real_apply_v1.md');
const PACKAGE_ID = 'ENRICH-21A-MFB-MEE-PARENT-GV-ID-BACKFILL';
const TARGET_SET_CODES = ['mfb', 'mee'];
const EXPECTED_FINGERPRINT = '9049c608b87e41ecbf617de26875fe83a0f0f7b88b46a816e9140e89824fa32b';
const EXPECTED_DRY_RUN_PROOF = 'df27b5998b09500d94a8878aa1bb69e23105de39a028167f632555eb2a5926df';
const EXPECTED_TARGET_ROWS = 42;
const APPROVAL_TEXT = 'Approve real ENRICH-21A-MFB-MEE-PARENT-GV-ID-BACKFILL apply only. Fingerprint: 9049c608b87e41ecbf617de26875fe83a0f0f7b88b46a816e9140e89824fa32b. Scope: 42 parent card_print gv_id updates for mfb/My First Battle and mee/Mega Evolution Energy using governed default namespace tokens MFB and MEE. Dry-run proof: df27b5998b09500d94a8878aa1bb69e23105de39a028167f632555eb2a5926df == df27b5998b09500d94a8878aa1bb69e23105de39a028167f632555eb2a5926df. No child writes. No identity writes. No external mapping writes. No species writes. No deletes. No merges. No migrations. No image writes. No global apply.';
...
async function applyPackage(client, targets) {
  ...
  try {
    ...
    if (
      ...
      preflight.bad_mfb_namespace_count !== 0 ||
      preflight.bad_mee_namespace_count !== 0 ||
...
async function main() {
  ...
  try {
    ...
    const report = {
      version: 'ENRICH21A_MFB_MEE_PARENT_GV_ID_REAL_APPLY_V1',
      package_id: PACKAGE_ID,
    ...
    await writeText(OUTPUT_MD, [
      '# ENRICH-21A MFB/MEE Parent GV-ID Real Apply V1',
      '',
      `Package: \`${PACKAGE_ID}\``,
      '',
      '## Result',
