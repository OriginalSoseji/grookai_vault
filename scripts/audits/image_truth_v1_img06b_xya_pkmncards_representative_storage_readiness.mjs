...
const INPUT_JSON = path.join(OUTPUT_DIR, 'image_truth_img06a_xya_pkmncards_representative_missing_display_dry_run_v1.json');
const OUTPUT_JSON = path.join(OUTPUT_DIR, 'image_truth_img06b_xya_pkmncards_representative_storage_readiness_v1.json');
const OUTPUT_MD = path.join(OUTPUT_DIR, 'image_truth_img06b_xya_pkmncards_representative_storage_readiness_v1.md');
const STORAGE_BUCKET = 'user-card-images';
const PACKAGE_ID = 'IMG-06B-XYA-PKMNCARDS-REPRESENTATIVE-STORAGE-READINESS-NO-UPLOAD';
...
function buildMarkdown(report) {
  return `# Image Truth V1 IMG-06B XYA PKMNCards Representative Storage Readiness
