...
const DRY_RUN_JSON = path.join(OUTPUT_DIR, 'tcgmap06b_fresh_tcgcsv_mapping_insert_guarded_dry_run_v1.json');
const OUTPUT_JSON = path.join(OUTPUT_DIR, 'tcgmap06b_fresh_tcgcsv_mapping_insert_real_apply_v1.json');
const OUTPUT_MD = path.join(OUTPUT_DIR, 'tcgmap06b_fresh_tcgcsv_mapping_insert_real_apply_v1.md');

const PACKAGE_ID = 'TCGMAP-06B-FRESH-TCGCSV-TCGPLAYER-MAPPING-INSERTS';
const EXPECTED_READINESS_FINGERPRINT = '8a0e4ab3ec98c1b984ed3e409a1f50ed888ddf8b5b805c427a865e238a6a25ac';
const EXPECTED_TARGET_FINGERPRINT = '3695c354cbbb59348d7940c8f1f9b08d496164c0bf596a7d1c63d9aa487b74ee';
const EXPECTED_DRY_RUN_PROOF = '4f53cda18c2baa0c0354bb5f9a3ecbe5ed12ab4d8e11ba873c2f11161202b945';
const EXPECTED_TARGET_ROWS = 1549;
const APPROVAL_TEXT = 'Approve real TCGMAP-06B-FRESH-TCGCSV-TCGPLAYER-MAPPING-INSERTS apply only.';
...
async function main() {
  ...
  const client = new Client({
    ...
    application_name: 'tcgmap06b_real_apply',
  });
...
main().catch((error) => {
  console.error('[tcgmap06b-real-apply] failed:', error);
  process.exit(1);
});
