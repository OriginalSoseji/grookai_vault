...
const APPLY_PLAN_JSON = path.join(
  OUTPUT_DIR,
  'self_hosted_images_wh09g_world_championship_extended_source_pointer_apply_plan_v1.json',
);
const APPLY_PLAN_MD = path.join(
  OUTPUT_DIR,
  'self_hosted_images_wh09g_world_championship_extended_source_pointer_apply_plan_v1.md',
);
const APPLY_RESULT_JSON = path.join(
  OUTPUT_DIR,
  'self_hosted_images_wh09g_world_championship_extended_source_pointer_apply_result_v1.json',
);
const APPLY_RESULT_MD = path.join(
  OUTPUT_DIR,
  'self_hosted_images_wh09g_world_championship_extended_source_pointer_apply_result_v1.md',
);

const PACKAGE_ID = 'IMG-HOST-WH-09G-WORLD-CHAMPIONSHIP-EXTENDED-SOURCE-POINTER-APPLY';
const SOURCE_DRY_RUN_PACKAGE_ID = 'IMG-HOST-WH-09F-WORLD-CHAMPIONSHIP-EXTENDED-SOURCE-POINTER-DRY-RUN';
const APPROVED_SOURCE_FINGERPRINT = '8f78cd09240ed49fa0344404b784b66e96f23260b36b399de90cfde5a3418220';
const APPROVED_PLAN_FILE_HASH = '9c58a0ccae57b2ab8ddf191fad40497a73959c2c5d3ee3d373cff1e618ae8773';
const EXPECTED_UPDATE_COUNT = 29;
