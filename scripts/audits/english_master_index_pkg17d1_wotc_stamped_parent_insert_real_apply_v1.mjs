...
const DRY_RUN_JSON = path.join(AUDIT_DIR, 'english_master_index_pkg17d1_wotc_stamped_parent_insert_guarded_dry_run_v1.json');
const OUTPUT_JSON = path.join(AUDIT_DIR, 'english_master_index_pkg17d1_wotc_stamped_parent_insert_real_apply_v1.json');
const OUTPUT_MD = path.join(AUDIT_DIR, 'english_master_index_pkg17d1_wotc_stamped_parent_insert_real_apply_v1.md');

const PACKAGE_ID = 'PKG-17D1-WOTC-STAMPED-PARENT-INSERTS';
const CREATED_BY = 'pkg17d1_wotc_stamped_parent_insert_real_apply_v1';
const EXPECTED_PACKAGE_FINGERPRINT = '070aebb1c6799b5691b3fa4597f41503fb8db839ee3577e4732a26fba34f7997';
const EXPECTED_DRY_RUN_PROOF = '94255ea5d9243448e63a21b679e0d2f1d3e4b677630fa64fd196c2d8c37d259e';
const EXPECTED_PRE_APPLY_HASH = '1430dfd5635d077ed5536744a5f6f0b47317f63faad3969a9359c193a5cfe908';
const EXPECTED_TARGET_COUNT = 10;
const APPROVAL_TEXT = 'Approve real PKG-17D1-WOTC-STAMPED-PARENT-INSERTS apply only. Fingerprint: 070aebb1c6799b5691b3fa4597f41503fb8db839ee3577e4732a26fba34f7997. Scope: 10 WOTC stamped parent inserts, 10 identity inserts, 10 child printing inserts; finishes holo=3, normal=7; sets base1=1, base2=2, base3=1, base5=3, gym1=2, gym2=1. Dry-run proof: 1430dfd5635d077ed5536744a5f6f0b47317f63faad3969a9359c193a5cfe908 == 1430dfd5635d077ed5536744a5f6f0b47317f63faad3969a9359c193a5cfe908. No global apply. No migrations. No deletes. No merges. No unsupported cleanup.';
...
function validateDryRun(dryRun) {
  ...
  if (dryRun.execution?.dry_run_status !== 'pkg17d1_completed_rolled_back_no_durable_change') findings.push('dry_run_status_not_passed');
...
async function applyPackage(client, targets, fingerprint) {
  ...
  try {
    ...
    return {
      apply_status: 'pkg17d1_real_apply_committed',
      guard: guardRow,
      proof: proof.rows[0],
      write_counts: {
...
function renderMarkdown(report) {
  return `# PKG-17D1 WOTC Stamped Parent Insert Real Apply V1

Approved real apply for PKG-17D1 only.
...
async function main() {
  ...
  const report = {
    ...
    version: 'english_master_index_pkg17d1_wotc_stamped_parent_insert_real_apply_v1',
