...
const DRY_RUN_JSON = path.join(AUDIT_DIR, 'english_master_index_pkg18g3_stamped_conflict_resolved_guarded_dry_run_v1.json');
const OUTPUT_JSON = path.join(AUDIT_DIR, 'english_master_index_pkg18g3_stamped_conflict_resolved_real_apply_v1.json');
const OUTPUT_MD = path.join(AUDIT_DIR, 'english_master_index_pkg18g3_stamped_conflict_resolved_real_apply_v1.md');

const PACKAGE_ID = 'PKG-18G3-STAMPED-CONFLICT-RESOLVED-PARENT-INSERTS';
const CREATED_BY = 'pkg18g3_stamped_conflict_resolved_real_apply_v1';
const EXPECTED_PACKAGE_FINGERPRINT = 'b8b55500f43f889df85d5c76aa1db4ac117209469fadfee565e045e7d48db108';
const EXPECTED_DRY_RUN_PROOF = 'b9703d52a7b5502322c8454da864c34ec67a0baf846263651eb7419c94200041';
const EXPECTED_PRE_APPLY_HASH = '6c6a57c2214e2ab15e96d0c1123190d4d6f6c864742f39692fc7a7091b5f599a';
const EXPECTED_TARGET_COUNT = 2;
const APPROVAL_TEXT = `Approve real PKG-18G3-STAMPED-CONFLICT-RESOLVED-PARENT-INSERTS apply only. Fingerprint: b8b55500f43f889df85d5c76aa1db4ac117209469fadfee565e045e7d48db108. Scope: 2 stamped parent inserts, 2 identity inserts, 2 child printing inserts; finishes cosmos=1, reverse=1; stamp labels GameStop Stamp=1, Regional Championships Stamp=1; sets me02=1, xy1=1. Dry-run proof: 6c6a57c2214e2ab15e96d0c1123190d4d6f6c864742f39692fc7a7091b5f599a == 6c6a57c2214e2ab15e96d0c1123190d4d6f6c864742f39692fc7a7091b5f599a. No global apply. No migrations. No deletes. No merges. No unsupported cleanup.`;
...
function validateDryRun(dryRun) {
  ...
  if (dryRun.execution?.dry_run_status !== 'pkg18g3_completed_rolled_back_no_durable_change') findings.push('dry_run_status_not_passed');
...
async function applyPackage(client, targets, fingerprint) {
  ...
  try {
    ...
    const childInsert = await client.query(
      `insert into public.card_printings (
       ...
       select
         ...
         concat('Stamped identity child finish routed from conflict-resolved exact evidence: ', target.target_finish_key)
       from pkg18g3_targets target`,
      [CREATED_BY],
    );
    ...
    return {
      apply_status: 'pkg18g3_real_apply_committed',
      guard: guardRow,
      proof: proof.rows[0],
      write_counts: {
...
function renderMarkdown(report) {
  ...
  return `# PKG-18G3 Stamped Conflict Resolved Real Apply V1

Approved real apply for conflict-resolved stamped parent identity inserts.
...
async function main() {
  ...
  const report = {
    ...
    version: 'english_master_index_pkg18g3_stamped_conflict_resolved_real_apply_v1',
    package_id: PACKAGE_ID,
