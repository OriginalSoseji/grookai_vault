...
const DRY_RUN_JSON = path.join(AUDIT_DIR, 'english_master_index_pkg18n2_bronzong_prize_pack_parent_insert_guarded_dry_run_v1.json');
const OUTPUT_JSON = path.join(AUDIT_DIR, 'english_master_index_pkg18n2_bronzong_prize_pack_parent_insert_real_apply_v1.json');
const OUTPUT_MD = path.join(AUDIT_DIR, 'english_master_index_pkg18n2_bronzong_prize_pack_parent_insert_real_apply_v1.md');

const PACKAGE_ID = 'PKG-18N2-BRONZONG-PRIZE-PACK-PARENT-INSERT';
const CREATED_BY = 'pkg18n2_bronzong_prize_pack_parent_insert_real_apply_v1';
const EXPECTED_PACKAGE_FINGERPRINT = '19652e0ab6a055565dc28794c039bea3eab6b6422306eed24ba7a45ca3477fdb';
const EXPECTED_DRY_RUN_PROOF = 'd1c7cd8e30b4e9f5c7d5eaf85b8366dd812ac5e9c2c6470bc39625ea2fe31339';
const EXPECTED_PRE_APPLY_HASH = 'f685254c0f86bb8352f165062b03ee5e0fd62b77d88acc679e48e66270454b14';
const EXPECTED_TARGET_COUNT = 1;
const APPROVAL_TEXT = `Approve real PKG-18N2-BRONZONG-PRIZE-PACK-PARENT-INSERT apply only. Fingerprint: 19652e0ab6a055565dc28794c039bea3eab6b6422306eed24ba7a45ca3477fdb. Scope: 1 stamped parent inserts, 1 identity inserts, 1 child printing inserts; finishes holo=1; stamp labels Prize Pack Stamp=1; sets swsh5=1. Dry-run proof: f685254c0f86bb8352f165062b03ee5e0fd62b77d88acc679e48e66270454b14 == f685254c0f86bb8352f165062b03ee5e0fd62b77d88acc679e48e66270454b14. No global apply. No migrations. No deletes. No merges. No unsupported cleanup.`;
...
function validateDryRun(dryRun) {
  ...
  if (dryRun.execution?.dry_run_status !== 'pkg18n2_completed_rolled_back_no_durable_change') findings.push('dry_run_status_not_passed');
...
async function applyPackage(client, targets, fingerprint) {
  ...
  try {
    ...
    return {
      apply_status: 'pkg18n2_real_apply_committed',
      guard: guardRow,
      proof: proof.rows[0],
      write_counts: {
...
function renderMarkdown(report) {
  ...
  return `# PKG-18N2 Bronzong Prize Pack Parent Insert Real Apply V1

Approved real apply for the Bronzong Battle Styles #102 Prize Pack stamped parent identity insert.
...
async function main() {
  ...
  const report = {
    ...
    version: 'english_master_index_pkg18n2_bronzong_prize_pack_parent_insert_real_apply_v1',
