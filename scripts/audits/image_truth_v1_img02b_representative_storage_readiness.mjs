...
const INPUT_JSON = path.join(OUTPUT_DIR, 'image_truth_img02a_representative_missing_display_dry_run_v1.json');
const OUTPUT_JSON = path.join(OUTPUT_DIR, 'image_truth_img02b_representative_storage_readiness_v1.json');
const OUTPUT_MD = path.join(OUTPUT_DIR, 'image_truth_img02b_representative_storage_readiness_v1.md');
const STORAGE_BUCKET = 'user-card-images';
const PACKAGE_ID = 'IMG-02B-REPRESENTATIVE-STORAGE-READINESS-NO-UPLOAD';
...
function buildMarkdown(report) {
  return `# Image Truth V1 IMG-02B Representative Storage Readiness
