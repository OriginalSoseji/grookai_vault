...
function renderMarkdown(report) {
  return [
    ...
    `- Candidate requests: \`${report.summary.candidate_request_count}\``,
    `- Provider call ceiling: \`${report.summary.provider_call_ceiling}\``,
    `- Skipped exhausted requests: \`${report.summary.skipped_request_count}\``,
    ...
    JSON.stringify({
      ...
      provider_call_lane_counts: report.summary.provider_call_lane_counts,
      skipped_reason_counts: report.summary.skipped_reason_counts,
    }, null, 2),
    "```",
    "",
    "## Findings",
