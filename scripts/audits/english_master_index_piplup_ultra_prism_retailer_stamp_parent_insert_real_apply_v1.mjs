...
const DRY_RUN_JSON = path.join(AUDIT_DIR, 'piplup_ultra_prism_retailer_stamp_parent_insert_guarded_dry_run_v1.json');
const OUTPUT_JSON = path.join(AUDIT_DIR, 'piplup_ultra_prism_retailer_stamp_parent_insert_real_apply_v1.json');
const OUTPUT_MD = path.join(AUDIT_DIR, 'piplup_ultra_prism_retailer_stamp_parent_insert_real_apply_v1.md');

const PACKAGE_ID = 'RETAILER-STAMP-05-PIPLUP-UPR-PARENT-IDENTITY-INSERTS';
const CREATED_BY = 'piplup_ultra_prism_retailer_stamp_parent_insert_real_apply_v1';
const EXPECTED_PACKAGE_FINGERPRINT = '25eed1a9dfbf22dba7972dd6acd292884721eb5b95d9911fbf33b0097d04b518';
const EXPECTED_DRY_RUN_PROOF = 'cad88e0272a752f2753091fe01f04d374adf9d7193887274b9f0a9e2adcf6e20';
const EXPECTED_PRE_APPLY_HASH = 'a48a953c186e8fcab228ae831216a70b06013027fcebcd116d28ff4b97b03d48';
...
function validateDryRun(dryRun) {
  ...
  if (dryRun.execution?.dry_run_status !== 'piplup_ultra_prism_retailer_stamp_parent_insert_completed_rolled_back_no_durable_change') findings.push('dry_run_status_not_passed');
...
async function applyPackage(client, targets) {
  ...
  try {
    ...
    return {
      apply_status: 'piplup_ultra_prism_retailer_stamp_parent_insert_applied',
      guard: guardRow,
      proof: proof.rows[0],
...
function renderMarkdown(report) {
  return `# Piplup Ultra Prism Retailer Stamp Parent Insert Real Apply V1

Real apply for the approved Piplup Ultra Prism #32 Build-A-Bear Workshop and Toys R Us stamped parent identity insert package.
...
async function main() {
  ...
  const report = {
    ...
    version: 'piplup_ultra_prism_retailer_stamp_parent_insert_real_apply_v1',
