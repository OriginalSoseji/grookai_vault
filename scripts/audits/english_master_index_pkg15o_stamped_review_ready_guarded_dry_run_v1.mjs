...
const OUTPUT_JSON = path.join(AUDIT_DIR, 'english_master_index_pkg15o_stamped_review_ready_guarded_dry_run_v1.json');
const OUTPUT_MD = path.join(AUDIT_DIR, 'english_master_index_pkg15o_stamped_review_ready_guarded_dry_run_v1.md');

const PACKAGE_ID = 'PKG-15O-STAMPED-REVIEW-READY-PARENT-INSERTS';
const CREATED_BY = 'pkg15o_stamped_review_ready_guarded_dry_run_v1';
...
async function runDryRun(client, targets, packageFingerprint) {
  ...
  try {
    ...
    return {
      dry_run_status: 'pkg15o_failed_rolled_back',
...
function renderMarkdown(report) {
  ...
  return `# PKG-15O Stamped Review-Ready Guarded Dry Run V1
...
async function main() {
  ...
  const report = {
    ...
    version: 'english_master_index_pkg15o_stamped_review_ready_guarded_dry_run_v1',
    package_id: PACKAGE_ID,
