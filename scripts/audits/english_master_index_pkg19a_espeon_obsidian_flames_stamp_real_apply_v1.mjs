...
const DRY_RUN_JSON = path.join(AUDIT_DIR, 'english_master_index_pkg19a_espeon_obsidian_flames_stamp_guarded_dry_run_v1.json');
const OUTPUT_JSON = path.join(AUDIT_DIR, 'english_master_index_pkg19a_espeon_obsidian_flames_stamp_real_apply_v1.json');
const OUTPUT_MD = path.join(AUDIT_DIR, 'english_master_index_pkg19a_espeon_obsidian_flames_stamp_real_apply_v1.md');

const PACKAGE_ID = 'PKG-19A-ESPEON-OBSIDIAN-FLAMES-STAMP-PARENT-INSERT';
const CREATED_BY = 'pkg19a_espeon_obsidian_flames_stamp_real_apply_v1';
const EXPECTED_PACKAGE_FINGERPRINT = '002bd396758bb0c42ca1eb84daef818c608d94a58eea345d3d68e30dbd72e60a';
const EXPECTED_DRY_RUN_PROOF = 'd023daded9f34e32822b686c9c5526b7a121edd62e16fb0c4d49dcdcc4126766';
const EXPECTED_PRE_APPLY_HASH = '29669a23e21d7a9514d1904919a04947e7429dd84455358bcd5b51898150175b';
const EXPECTED_TARGET_COUNT = 1;
const APPROVAL_TEXT = 'Approve real PKG-19A-ESPEON-OBSIDIAN-FLAMES-STAMP-PARENT-INSERT apply only. Fingerprint: 002bd396758bb0c42ca1eb84daef818c608d94a58eea345d3d68e30dbd72e60a. Scope: 1 stamped parent inserts, 1 identity inserts, 1 child printing inserts; finishes reverse=1; stamp labels Obsidian Flames Stamp=1; sets sv03=1. Dry-run proof: 29669a23e21d7a9514d1904919a04947e7429dd84455358bcd5b51898150175b == 29669a23e21d7a9514d1904919a04947e7429dd84455358bcd5b51898150175b. No global apply. No migrations. No deletes. No merges. No unsupported cleanup.';
...
function validateDryRun(dryRun) {
  ...
  if (dryRun.execution?.dry_run_status !== 'pkg19a_completed_rolled_back_no_durable_change') findings.push('dry_run_status_not_passed');
...
function buildTargets(readiness) {
  return (readiness.rows ?? [])
    ...
    .map((row) => ({
      ...
      evidence_label: `${row.source_count} exact sources support Obsidian Flames Stamp reverse`,
      evidence: {
        ...
        evidence_label: `${row.source_count} exact sources support Obsidian Flames Stamp reverse`,
        raw_snapshot_ref: `pkg19a:${row.set_key}:${row.card_number}:${row.variant_key}:${row.finish_key}`,
        stamp_label: row.stamp_label,
...
async function applyPackage(client, targets, fingerprint) {
  ...
  try {
    ...
    return {
      apply_status: 'pkg19a_real_apply_committed',
      guard: guardRow,
      proof: proof.rows[0],
      write_counts: {
...
function renderMarkdown(report) {
  ...
  return `# PKG-19A Espeon Obsidian Flames Stamp Real Apply V1

Approved real apply for the Espeon Obsidian Flames Stamp reverse parent identity insert.
...
async function main() {
  ...
  const report = {
    ...
    version: 'english_master_index_pkg19a_espeon_obsidian_flames_stamp_real_apply_v1',
    package_id: PACKAGE_ID,
