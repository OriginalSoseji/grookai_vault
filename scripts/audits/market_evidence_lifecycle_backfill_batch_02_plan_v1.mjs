...
const PACKAGE_DIR = path.join(AUDIT_DIR, "MEE_CORE_LIFECYCLE_BACKFILL_BATCH_02_PLAN_V1");
const PACKAGE_ID = "MEE-CORE-LIFECYCLE-BACKFILL-BATCH-02-V1";
const CONTRACT_VERSION = "MARKET_EVIDENCE_ENGINE_CORE_V1";
const EVENT_VERSION = "MEE_CORE_LIFECYCLE_BACKFILL_BATCH_02_PLAN_V1";
const TOTAL_LIMIT = 5000;
const REFERENCE_LIMIT = 2500;
const LISTING_LIMIT = 2500;
...
const report = {
  ...
  artifacts: {
    observations_jsonl:
      "docs/audits/market_evidence_engine_v1/MEE_CORE_LIFECYCLE_BACKFILL_BATCH_02_PLAN_V1/market_evidence_observations.jsonl",
    lifecycle_events_jsonl:
      "docs/audits/market_evidence_engine_v1/MEE_CORE_LIFECYCLE_BACKFILL_BATCH_02_PLAN_V1/market_evidence_lifecycle_events.jsonl",
    readback_sql:
      "docs/audits/market_evidence_engine_v1/MEE_CORE_LIFECYCLE_BACKFILL_BATCH_02_PLAN_V1/readback.sql",
    manifest_json:
      "docs/audits/market_evidence_engine_v1/MEE_CORE_LIFECYCLE_BACKFILL_BATCH_02_PLAN_V1/manifest.json",
    report_md:
      "docs/audits/market_evidence_engine_v1/MEE_CORE_LIFECYCLE_BACKFILL_BATCH_02_PLAN_V1.md",
  },
  boundary_proof: {
    db_writes: false,
...
writeFileSync(path.join(AUDIT_DIR, "MEE_CORE_LIFECYCLE_BACKFILL_BATCH_02_PLAN_V1.md"), renderMarkdown(report));
