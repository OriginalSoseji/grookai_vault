...
import { buildAccountCanaryPlan, CANARY_PROJECT } from '../../backend/pricing/sealed_ownership_account_canary_plan_v1.mjs';
...
const snapshot = await withReadOnlyClient({ connectionString, environmentLabel: 'sealed-account-canary-plan', statementTimeoutMs: 30000 },
  (client, guard) => captureCanarySnapshot(client, guard, versions));
