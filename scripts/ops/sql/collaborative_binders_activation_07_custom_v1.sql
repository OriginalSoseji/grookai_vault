...
eligible as materialized (
  ...
  where state.flag_count = 11
    ...
    and state.enabled_before = array['community','personal','public','schema_internal','shared','view_links']::text[]
...
select jsonb_build_object(
  ...
  'enabled_after', '["community","custom","personal","public","schema_internal","shared","view_links"]'::jsonb,
