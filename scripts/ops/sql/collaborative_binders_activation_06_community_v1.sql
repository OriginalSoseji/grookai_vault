...
eligible as materialized (
  ...
  where state.flag_count = 11
    ...
    and state.enabled_before = array['personal','public','schema_internal','shared','view_links']::text[]
...
changed as (
  ...
  set enabled = true
  from eligible
  where target.flag_key = 'community'
...
select jsonb_build_object(
  ...
  'phase_sequence', 6,
  'target_flag', 'community',
  'enabled_before', to_jsonb(flag_state.enabled_before),
  'enabled_after', '["community","personal","public","schema_internal","shared","view_links"]'::jsonb,
