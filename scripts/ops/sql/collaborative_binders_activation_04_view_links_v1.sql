...
eligible as materialized (
  ...
  where state.flag_count = 11
    ...
    and state.enabled_before = array['personal','schema_internal','shared']::text[]
...
changed as (
  ...
  set enabled = true
  from eligible
  where target.flag_key = 'view_links'
...
select jsonb_build_object(
  ...
  'phase_sequence', 4,
  'target_flag', 'view_links',
  'enabled_before', to_jsonb(flag_state.enabled_before),
  'enabled_after', '["personal","schema_internal","shared","view_links"]'::jsonb,
